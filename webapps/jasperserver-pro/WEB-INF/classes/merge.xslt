...
<!-- SAM added doctype params -->
<xslt:param name="doctype-public" select="" />
<xslt:param name="doctype-system" select="" />
...
<xslt:template match="*">
   ...
   <!-- SAM added doctype param handling -->
   <xslt:if test="$doctype-public!='' and $doctype-system!=''">
     <xslt:text disable-output-escaping="yes">
       <![CDATA[<!DOCTYPE ]]></xslt:text><xslt:value-of select="name(/node())"/><xslt:text disable-output-escaping="yes"><![CDATA[ PUBLIC ]]></xslt:text>&quot;<xslt:value-of select="$doctype-public"/>&quot; &quot;<xslt:value-of select="$doctype-system"/>&quot;<xslt:text disable-output-escaping="yes">></xslt:text>
     &#xA;
   </xslt:if>
         ...
         <xslt:choose>
            ...
            <xslt:otherwise>
               <xslt:choose>
                  ...
                  <xslt:when test="$type1='element'">
                     <xslt:element name="{name($first1)}"> 
<!-- namespaces... we don't need no stinkin' namespaces.                -SAM  -->
<!--                                   namespace="{namespace-uri($first1)}">  -->
                        <xslt:copy-of select="$first1/namespace::*" />
                        <xslt:copy-of select="$first2/namespace::*" />
                        <xslt:copy-of select="$first1/@*" />
