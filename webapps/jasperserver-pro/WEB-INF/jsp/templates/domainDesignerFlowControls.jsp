...
<div class="tabs">
    ...
    <t:insertTemplate template="/WEB-INF/jsp/templates/control_tabSet.jsp">
        ...
        <t:putListAttribute name="tabset">
            ...
            <c:choose>
                <c:when test="${not displayOnly}">
                    <t:addListAttribute>
                        <t:addAttribute>tablesTab</t:addAttribute>
                        <t:addAttribute><spring:message code='button.designerTables'
                                                        javaScriptEscape='true'/></t:addAttribute>
                    ...
                    <t:addListAttribute>
                        ...
                        <t:addAttribute><spring:message code='button.designerDerivedTables'
                                                        javaScriptEscape='true'/></t:addAttribute>
                    ...
                    <t:addListAttribute>
                        ...
                        <t:addAttribute><spring:message code='button.designerJoins'
                                                        javaScriptEscape='true'/></t:addAttribute>
                    ...
                    <t:addListAttribute>
                        ...
                        <t:addAttribute><spring:message code='button.designerCalcFields'
                                                        javaScriptEscape='true'/></t:addAttribute>
                    ...
                    <t:addListAttribute>
                        ...
                        <t:addAttribute><spring:message code='button.designerPreFilters'
                                                        javaScriptEscape='true'/></t:addAttribute>
    ...
    <ul class="list buttonSet">
    	<li class="node open">
    		<ul class="list buttonSet">
		        ...
		        <!-- extra button for derived tables tab -->
		        <c:if test="${selectedTab eq 'derivedTables'}">
		            <li class="leaf">
...
<!-- COMBINED WITH ABOVE LIST FOR BORDER AND SPACING PURPOSES, AMBER 2 THEME
    	<li class="node open">
    		<ul class="list buttonSet">
