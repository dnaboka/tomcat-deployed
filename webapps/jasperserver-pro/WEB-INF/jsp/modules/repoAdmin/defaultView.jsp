...
<c:choose>
  ...
  <tr id="reportOptionsRow_${resource.name}_${optionStatus.count}" style="display:none"
    ...
    <td class="paddedcell">${option.label}</td>
...
<script language="JavaScript">
  checkboxListInit('repositoryItems', 'frm', 'selectAll', ['selectedFolders', 'selectedResources'], ${repositoryItemCount}, 0);
</script>

<c:if test="${not empty reportOptionsExpanded}">
<script language="JavaScript">
    expandToggle('reportOptions', '${reportOptionsExpanded}');
</script>
</c:if>
