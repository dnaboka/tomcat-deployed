        ...
        <t:insertTemplate template="/WEB-INF/jsp/templates/container.jsp">
            ...
            <t:putAttribute name="bodyContent">
                <iframe id="outerFrame" class="outerDashboardFrame" name="Dashboard" allowtransparency="true" align="center" marginwidth="0" marginheight="0" hspace="0" vspace="0" frameborder="0" height="99.5%" width="100%" scrolling="no"
                        src="${pageContext.request.contextPath}/dashboard/viewer.html?viewAsDashboardFrame=true&isJasperAnalysis=<%=licenseManager.isAnalysisFeatureSupported()?"true":"false"%>#${demoHomeResource}">
                </iframe>
            </t:putAttribute>
        </t:insertTemplate>
    </t:putAttribute>
