...
<t:insertTemplate template="/WEB-INF/jsp/templates/page.jsp">
    ...
    <t:putAttribute name="moduleName" value="domain/domainDesignerDisplayMain"/>
    ...
    <t:putAttribute name="bodyContent" >
        ...
        <t:insertTemplate template="/WEB-INF/jsp/templates/standardConfirm.jsp">
            ...
            <t:putAttribute name="containerElements"><div class="sizer diagonal" style='display: none;'></div></t:putAttribute>
            <t:putAttribute name="bodyContent">
                ...
                <div id="dependentResourcesConfirmMessage" class="hidden"></div>
            </t:putAttribute>
