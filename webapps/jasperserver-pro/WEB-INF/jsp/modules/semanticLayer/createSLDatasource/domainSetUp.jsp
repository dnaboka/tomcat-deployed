...
<t:insertTemplate template="/WEB-INF/jsp/templates/page.jsp">
    ...
    <t:putAttribute name="moduleName" value="domain/domainSetupMain"/>
                                ...
                                <t:putAttribute name="bodyContent">
                                    ...
                                    <fieldset class="group first">
                                        ...
                                        <label class="control browser" for="schemaLocation" title="<spring:message code="CSLD_PATH_IN_REPO_TOOLTIP"/>">
                                            ...
                                            <button class="button action" type="button" id="browser_button"><span class="wrap"><spring:message code="button.browse"/><span class="icon"></span></span></button>
                                            <span class="message warning">error message here</span>
                                        </label>
                                    </fieldset>
                                    <fieldset class="group">
                                        ...
                                        <label class="control browser" for="dataSourceInput" title="<spring:message code="CSLD_SELECT_DATASOURCE_TOOLTIP"/>">
                                            ...
                                            <button class="button action" type="button" id="ds_browser_button"><span class="wrap"><spring:message code="button.browse"/><span class="icon"></span></span></button>
                                            <span class="message warning">error message here</span>
                                        </label>
                                    </fieldset>
                                    <fieldset class="group">
                                        <legend class="label" style="overflow:visible;"><span class="wrap"><spring:message code="CSLD_DOMAIN_SCHEMA"/></span></legend>
