...
<t:insertTemplate template="/WEB-INF/jsp/templates/page.jsp">
    ...
    <t:putAttribute name="moduleName" value="dataChooser/dataChooserFieldsMain"/>
		...
		<t:insertTemplate template="/WEB-INF/jsp/templates/container.jsp">
            ...
            <div id="stepDisplay">
                <fieldset class="row instructions">
                    ...
                    <h2 class="textAccent02"><spring:message code='page.fields.chooseData' javaScriptEscape='true'/></h2>
                    <h4><spring:message code='page.fields.chooseData.info' javaScriptEscape='true'/></h4>
                </fieldset>
