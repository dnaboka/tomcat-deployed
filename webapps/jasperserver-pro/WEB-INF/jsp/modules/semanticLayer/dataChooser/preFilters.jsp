...
<t:insertTemplate template="/WEB-INF/jsp/templates/page.jsp">
    ...
    <t:putAttribute name="moduleName" value="dataChooser/dataChooserPreFiltersMain"/>
    ...
    <t:putAttribute name="bodyContent" >
        ...
        <t:insertTemplate template="/WEB-INF/jsp/templates/container.jsp">
            ...
            <t:putAttribute name="footerContent">
                ...
                <label class="control checkBox lock" title="<spring:message code="page.filters.filter.lock.title" />">
                    <span class="wrap"><spring:message code="page.filters.filter.locked" /></span>
                    <input class="editable" type="checkbox" value="true"/>
                </label>
            </t:putAttribute>
        </t:insertTemplate>
