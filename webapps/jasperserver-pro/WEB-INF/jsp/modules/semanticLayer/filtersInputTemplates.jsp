...
<fieldset id="booleanComboValues" class="column two hidden">
    <div class="control combo errorContainer">
        <span class="wrap"></span>
        <span class="control booleanInput">
            <div class="wrap">
                <input class="booleanComboInput" name="booleanComboInput" type="text" value="" />
            </div>
        </span>
        <select class="">
            <option selected="selected" class="empty" title="null" value="null"></option>
