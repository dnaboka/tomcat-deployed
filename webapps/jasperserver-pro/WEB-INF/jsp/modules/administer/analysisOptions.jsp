		...
		<t:insertTemplate template="/WEB-INF/jsp/templates/container.jsp">
		    ...
		    <t:putAttribute name="bodyContent">
                ...
                <%
                  ...
                  AdhocConfiguration adhocConfiguration = context.getBean("adhocConfiguration", AdhocConfiguration.class);
                  String oName;
                  String oDesc;
                  String oLabelCode;
                  Object oValue;
				...
				<ol class="list settings">
					<li class="node">
						...
						<ol class="list settings">
                            ...
                            <%
                                request.setAttribute("oName", "adhoc.olap.maxFilterValues");
                                request.setAttribute("oLabelCode", "JAM_071_MAX_FILTER_COUNT");
                                request.setAttribute("oValue", adhocConfiguration.getAdhocOlapMaxFilters());
                            %>
