...
<head>
    ...
    <!-- Fixes http://jira.jaspersoft.com/browse/JRS-11522, commonScripts.jsp must be loaded to load setScriptOptimizationProps.jsp to populate the value
            for the ${scriptsFoler} placeholder used to populate the <link> elements below. -->
    <%-- requirejs module name --%>
    <c:set var="moduleName" value="dashboardDeprecated/dashboardDesignerFrameMain"/>

    <jsp:include page="../commonScripts.jsp"/>
    <jsp:include page="../common/jrsConfigs.jsp"/>
    <jsp:include page="dashboardDesignerViewFrameState.jsp"/>
