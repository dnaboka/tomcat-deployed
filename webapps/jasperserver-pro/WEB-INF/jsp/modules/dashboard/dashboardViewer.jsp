...
<t:insertTemplate template="/WEB-INF/jsp/templates/page.jsp">
    ...
    <c:if test='${!empty param.viewAsDashboardFrame && param.viewAsDashboardFrame != "false"}'>
        <t:putAttribute name="moduleName" value="dashboardDeprecated/dashboardRuntimeFrameMain"/>
    </c:if>
    <c:if test='${empty param.viewAsDashboardFrame || param.viewAsDashboardFrame == "false"}'>
        <t:putAttribute name="moduleName" value="dashboardDeprecated/dashboardRuntimeMain"/>
    </c:if>
            ...
            <t:putAttribute name="headerContent">
                <c:if test="${requestScope.dashboardState.title != null}">
                    <div id="title" class="emphasis larger">
                        ${requestScope.dashboardState.title}
                    </div>
                </c:if>
            </t:putAttribute>
                ...
                <div id="dashboardFrameParent">
                    ...
                    <c:forEach var="frame" items="${textFrames}" varStatus="frameStatus">
                        <div id="textFrameContainer_${frame.name}"
                            ...
                            <input class="edit" type="text" value="${frame.textLabel}"/>
                        </div>
                    </c:forEach>
