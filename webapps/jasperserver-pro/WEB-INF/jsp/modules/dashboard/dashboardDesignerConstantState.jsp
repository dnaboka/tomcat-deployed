...
<script type="text/javascript" id="dashboardDesignerConstantState">
    ...
    localContext.CUSTOM_RESOURCE_TYPE = "${viewModel.customResourceType}";
    ...
    localContext.DASHBOARD_CUSTOM_URL_ERROR = "<spring:message code='DASHBOARD_CUSTOM_URL_ERROR' javaScriptEscape='true'/>";
