...
HighChartUnitTests.prototype.findChildWithLabel = function(treeNode, label) {
    for (var i=0; i<treeNode.children.length; i++) {
        if (treeNode.children[i].label === label)  return treeNode.children[i];
    }
    return null;
};
...
//
//   obj2
//   row0    Store Sales total
//
HighChartUnitTests.prototype.checkObj2Row0 = function(inp) {
   if (inp.length != 1)        alert("checkObj2Row0: error  01");

   var c = inp[0];
   if (c.axisCoordinate != 3)      alert("checkObj2Row0: error  02");
...
//
//   obj2
//   col0    ALL Countries  total
//
HighChartUnitTests.prototype.checkObj2Col0 = function(inp) {
   if (inp.length != 1)        alert("checkObj2Col0: error  01");

   var c = inp[0];
   if (c.axisCoordinate != 15)      alert("checkObj2Col0: error  02");
...
//
//   obj2
//   row1   Product Family totals
//
HighChartUnitTests.prototype.checkObj2Row1 = function(inp) {
   if (inp.length != 3)        alert("checkObj2Row1: error  01");

   var c = inp[0];
   if (c.axisCoordinate != 0)      alert("checkObj2Row1: error  02");

   var c = inp[1];
   if (c.axisCoordinate != 1)      alert("checkObj2Row1: error  04");

   var c = inp[2];
   if (c.axisCoordinate != 2)      alert("checkObj2Row1: error  05");
...
//
//   obj2
//   col1    ALL Countries  total
//
HighChartUnitTests.prototype.checkObj2Col1 = function(inp) {
   if (inp.length != 3)        alert("checkObj2Col1: error  01");

   var c = inp[0];
   if (c.axisCoordinate != 1)      alert("checkObj2Col1: error  02");

   var c = inp[1];
   if (c.axisCoordinate != 10)      alert("checkObj2Col1: error  03");

   var c = inp[2];
   if (c.axisCoordinate != 14)      alert("checkObj2Col1: error  04");
...
//
//   obj2
//   col2    ALL States  total
//
HighChartUnitTests.prototype.checkObj2Col2 = function(inp) {
   if (inp.length != 12)        alert("checkObj2Col2: error  01");

   var c = inp[0];
   if (c.axisCoordinate != 0)      alert("checkObj2Col2: error  02");

   var c = inp[1];
   if (c.axisCoordinate != 2)      alert("checkObj2Col2: error  03");

   var c = inp[2];
   if (c.axisCoordinate != 3)      alert("checkObj2Col2: error  04");
   var c = inp[3];
   if (c.axisCoordinate != 4)      alert("checkObj2Col2: error  05");
   var c = inp[4];
   if (c.axisCoordinate != 5)      alert("checkObj2Col2: error  06");
   var c = inp[5];
   if (c.axisCoordinate != 6)      alert("checkObj2Col2: error  07");
   var c = inp[6];
   if (c.axisCoordinate != 7)      alert("checkObj2Col2: error  08");
   var c = inp[7];
   if (c.axisCoordinate != 8)      alert("checkObj2Col2: error  09");
   var c = inp[8];
   if (c.axisCoordinate != 9)      alert("checkObj2Col2: error  10");
   var c = inp[9];
   if (c.axisCoordinate != 11)      alert("checkObj2Col2: error  11");
   var c = inp[10];
   if (c.axisCoordinate != 12)      alert("checkObj2Col2: error  12");
   var c = inp[11];
   if (c.axisCoordinate != 13)      alert("checkObj2Col2: error  13");
...
//
//   obj3
//   countries (2), measures (2), states (4)
//
//    2 totals for 2 measures
HighChartUnitTests.prototype.checkObj3Col10 = function(inp) {
   if (inp.length != 2)        alert("checkObj3Col10: error  03");

   var c = inp[0];
   if (c.axisCoordinate != 16)      alert("checkObj3Col10: error  19");

   c = inp[1];
   if   (c.axisCoordinate != 21)      alert("checkObj3Col10: error  29");
};
...
//   countries (2), measures (2), states (4)
//
//   2 countries  2 measures
//
HighChartUnitTests.prototype.checkObj3Col11 = function(inp) {
   if (inp.length != 4)        alert("checkObj3Col11: error  01");

   var c = inp[0];
   if (c.axisCoordinate != 1)      alert("checkObj3Col11: error  02");

   c = inp[1];
   if   (c.axisCoordinate != 3)      alert("checkObj3Col11: error  03");

   c = inp[2];
   if   (c.axisCoordinate != 7)      alert("checkObj3Col11: error  04");

   c = inp[3];
   if   (c.axisCoordinate != 11)      alert("checkObj3Col11: error  05");
};
...
//   countries (2), measures (2), states (4)
//
//   4 countries  2 measures
//
HighChartUnitTests.prototype.checkObj3Col12 = function(inp) {
   if (inp.length != 8)        alert("checkObj3Col12: error  01");

   var c = inp[0];
   if (c.axisCoordinate != 0)      alert("checkObj3Col12: error  02");

   c = inp[1];
   if   (c.axisCoordinate != 2)      alert("checkObj3Col12: error  03");

   c = inp[2];
   if   (c.axisCoordinate != 4)      alert("checkObj3Col12: error  04");

   c = inp[3];
   if   (c.axisCoordinate != 5)      alert("checkObj3Col12: error  05");

   c = inp[4];
   if   (c.axisCoordinate != 6)      alert("checkObj3Col12: error  05");

   c = inp[5];
   if   (c.axisCoordinate != 8)      alert("checkObj3Col12: error  05");

   c = inp[6];
   if   (c.axisCoordinate != 9)      alert("checkObj3Col12: error  05");

   c = inp[7];
   if   (c.axisCoordinate != 10)      alert("checkObj3Col12: error  05");
};


//
// testcase  obj4   grand totals for 3 measures
//   var testNodeListColSlider10 = this.DataProcessor.getNodeListForSliderLevel(1, 0);
//
HighChartUnitTests.prototype.checkObj4Col10 = function(inp) {
   if (inp.length != 3)        alert("checkObj4Col10: error  03");

   var c = inp[0];
   if (c.axisCoordinate != 24)      alert("checkObj4Col10: error  19");

   c = inp[1];
   if   (c.axisCoordinate != 25)      alert("checkObj4Col10: error  29");

   c = inp[2];
   if   (c.axisCoordinate != 26)      alert("checkObj4Col10: error  39");
};


//
// testcase  obj4   totals for  country USA  3 measures
//   var testNodeListColSlider10 = this.DataProcessor.getNodeListForSliderLevel(1, 0);
//
HighChartUnitTests.prototype.checkObj4Col11 = function(inp) {
   if (inp.length != 3)        alert("checkObj4Col11: error  03");

   var c = inp[0];
   if (c.axisCoordinate != 21)      alert("checkObj4Col11: error  19");

   c = inp[1];
   if   (c.axisCoordinate != 22)      alert("checkObj4Col11: error  29");

   c = inp[2];
   if   (c.axisCoordinate != 23)      alert("checkObj4Col11: error  39");
};



//
// testcase  obj4   totals for  2 states   3 measures
//   var testNodeListColSlider10 = this.DataProcessor.getNodeListForSliderLevel(1, 0);
//
HighChartUnitTests.prototype.checkObj4Col12 = function(inp) {
   if (inp.length != 6)        alert("checkObj4Col12: error  03");

   var c = inp[0];
   if (c.axisCoordinate != 9)      alert("checkObj4Col12: error  9");

   c = inp[1];
   if   (c.axisCoordinate != 10)      alert("checkObj4Col12: error  19");

   c = inp[2];
   if   (c.axisCoordinate != 11)      alert("checkObj4Col12: error  39");

   var c = inp[3];
   if (c.axisCoordinate != 18)      alert("checkObj4Col12: error  49");

   c = inp[4];
   if   (c.axisCoordinate != 19)      alert("checkObj4Col12: error  59");

   c = inp[5];
   if   (c.axisCoordinate != 20)      alert("checkObj4Col12: error  69");
...
//
// testcase  obj4   totals for  5 cities    3 measures
//   var testNodeListColSlider10 = this.DataProcessor.getNodeListForSliderLevel(1, 0);
//
HighChartUnitTests.prototype.checkObj4Col13 = function(inp) {
   if (inp.length != 15)        alert("checkObj4Col13: error  01");

   var c = inp[0];
   if (c.axisCoordinate != 0)      alert("checkObj4Col13: error  02");

   c = inp[1];
   if   (c.axisCoordinate != 1)      alert("checkObj4Col13: error  03");

   c = inp[2];
   if   (c.axisCoordinate != 2)      alert("checkObj4Col13: error  04");

   var c = inp[3];
   if (c.axisCoordinate != 3)      alert("checkObj4Col13: error  05");

   c = inp[4];
   if   (c.axisCoordinate != 4)      alert("checkObj4Col13: error  06");

   c = inp[5];
   if   (c.axisCoordinate != 5)      alert("checkObj4Col13: error  07");

   c = inp[6];
   if   (c.axisCoordinate != 6)      alert("checkObj4Col13: error  08");

   c = inp[7];
   if   (c.axisCoordinate != 7)      alert("checkObj4Col13: error  09");

   var c = inp[8];
   if (c.axisCoordinate != 8)      alert("checkObj4Col13: error  10");


   c = inp[9];
   if   (c.axisCoordinate != 12)      alert("checkObj4Col13: error  11");

   c = inp[10];
   if   (c.axisCoordinate != 13)      alert("checkObj4Col13: error  12");

   c = inp[11];
   if   (c.axisCoordinate != 14)      alert("checkObj4Col13: error  13");

   c = inp[12];
   if   (c.axisCoordinate != 15)      alert("checkObj4Col13: error  14");


   c = inp[13];
   if   (c.axisCoordinate != 16)      alert("checkObj4Col13: error  15");

   c = inp[14];
   if   (c.axisCoordinate != 17)      alert("checkObj4Col13: error  16");
};


//
//  obj5     l level countries only
//

HighChartUnitTests.prototype.checkObj5Col10  = function(inp) {
    if (inp.length != 1)        alert("checkObj5Col10: error  01");
   var c = inp[0];
   if (c.axisCoordinate != 3)      alert("checkObj5Col10: error  02");
};


//
//  obj5     l level countries only     3 countries
//

HighChartUnitTests.prototype.checkObj5Col11  = function(inp) {
    if (inp.length != 3)        alert("checkObj5Col11: error  01");
   var c = inp[0];
   if (c.axisCoordinate != 0)      alert("checkObj5Col11: error  02");

   var c = inp[1];
   if (c.axisCoordinate != 1)      alert("checkObj5Col11: error  02");

   var c = inp[2];
   if (c.axisCoordinate != 2)      alert("checkObj5Col11: error  02");
};


// testcase  obj5 simple tree
//   var testNodeListColSlider0 = this.DataProcessor.getNodeListForSliderLevel(1, 0);
//
...
//   var testNodeListColSlider11 = this.DataProcessor.getNodeListForSliderLevel(1, 1);
//
...
//
//  Obj6Col10   3  leaf level ALL  for 3 measures
//
HighChartUnitTests.prototype.checkObj6Col10 = function(inp) {
    if (inp.length != 3)  alert("checkObj6Col10: error  1");
    var c = inp[0];
    if (c.axisCoordinate != 6)   alert("checkObj6Col10: error  2");
    if (c.label != "ALL")  alert("checkObj6Col10: error  4");
    c = inp[1];
    if (c.axisCoordinate != 13)   alert("checkObj6Col10: error  3");
    if (c.label != "ALL")  alert("checkObj6Col10: error  5");
    c = inp[2];
    if (c.axisCoordinate != 20)   alert("checkObj6Col10: error  6");
    if (c.label != "ALL")  alert("checkObj6Col10: error  7");
};


//
//  obj6  2  countries    for 3 Measures
//
HighChartUnitTests.prototype.checkObj6Col11 = function(inp) {
    if (inp.length != 6)  alert("checkObj6Col11: error  1");
    var c = inp[0];
    if (c.axisCoordinate != 1)   alert("checkObj6Col11: error  2");
    //if (c.label != "Store Sales")  alert("checkObj6Col11: error  4");
    //if (c.parent.parent.label != "Canada") alert("checkObj6Col11: error  5");
    c = inp[1];
    if (c.axisCoordinate != 5)   alert("checkObj6Col11: error  6");
    //if (c.label != "Store Cost")  alert("checkObj6Col11: error  7");
    //if (c.parent.parent.label != "Canada") alert("checkObj6Col11: error  8");
    c = inp[2];
    if (c.axisCoordinate != 8)   alert("checkObj6Col11: error  12");
    //if (c.label != "Store Sales")  alert("checkObj6Col11: error  14");
    //if (c.parent.parent.label != "USA") alert("checkObj6Col11: error  15");
    c = inp[3];
    if (c.axisCoordinate != 12)   alert("checkObj6Col11: error  16");
    //if (c.label != "Store Cost")  alert("checkObj6Col11: error  17");
    //if (c.parent.parent.label != "USA") alert("checkObj6Col11: error  18");

    c = inp[4];
    if (c.axisCoordinate != 15)   alert("checkObj6Col11: error  22");
    //if (c.label != "Store Sales")  alert("checkObj6Col11: error  24");
    //if (c.parent.parent.label != "USA") alert("checkObj6Col11: error  25");
    c = inp[5];
    if (c.axisCoordinate != 19)   alert("checkObj6Col11: error  26");
    //if (c.label != "Store Cost")  alert("checkObj6Col11: error  27");
    //if (c.parent.parent.label != "USA") alert("checkObj6Col11: error  28");
};


//
//  obj6  4  states    for 3 Measures
//
HighChartUnitTests.prototype.checkObj6Col12 = function(inp) {
    if (inp.length != 12)  alert("checkObj6Col12: error  1");
    var c = inp[0];
    if (c.axisCoordinate != 0)   alert("checkObj6Col12: error  2");
    if (c.label != "BC")  alert("checkObj6Col12: error  4");
    //if (c.parent.label != "Canada") alert("checkObj6Col12: error  5");
    c = inp[1];
    if (c.axisCoordinate != 2)   alert("checkObj6Col12: error  6");
    if (c.label != "CA")  alert("checkObj6Col12: error  7");
    //if (c.parent.label != "Canada") alert("checkObj6Col12: error  8");
    c = inp[2];
    if (c.axisCoordinate != 3)   alert("checkObj6Col12: error  12");
    if (c.label != "OR")  alert("checkObj6Col12: error  14");
    //if (c.parent.label != "USA") alert("checkObj6Col12: error  15");
    c = inp[3];
    if (c.axisCoordinate != 4)   alert("checkObj6Col12: error  16");
    if (c.label != "WA")  alert("checkObj6Col12: error  17");
    //if (c.parent.label != "USA") alert("checkObj6Col12: error  18");

    c = inp[4];
    if (c.axisCoordinate != 7)   alert("checkObj6Col12: error  22");
    if (c.label != "BC")  alert("checkObj6Col12: error  24");
    //if (c.parent.parent.label != "USA") alert("checkObj6Col12: error  25");
    c = inp[5];
    if (c.axisCoordinate != 9)   alert("checkObj6Col12: error  26");
    if (c.label != "CA")  alert("checkObj6Col12: error  27");
    //if (c.parent.label != "USA") alert("checkObj6Col12: error  28");
    var c = inp[6];
    if (c.axisCoordinate != 10)   alert("checkObj6Col12: error  32");
    if (c.label != "OR")  alert("checkObj6Col12: error  34");
    //if (c.parent.label != "USA") alert("checkObj6Col12: error  35");
    c = inp[7];
    if (c.axisCoordinate != 11)   alert("checkObj6Col12: error  36");
    if (c.label != "WA")  alert("checkObj6Col12: error  37");
    //if (c.parent.label != "USA") alert("checkObj6Col12: error  38");
    var c = inp[8];
    if (c.axisCoordinate != 14)   alert("checkObj6Col12: error  42");
    if (c.label != "BC")  alert("checkObj6Col12: error  44");
    //if (c.parent.label != "Canada") alert("checkObj6Col12: error  45");
    c = inp[9];
    if (c.axisCoordinate != 16)   alert("checkObj6Col12: error  46");
    if (c.label != "CA")  alert("checkObj6Col12: error  47");
    //if (c.parent.label != "USA") alert("checkObj6Col12: error  48");
    var c = inp[10];
    if (c.axisCoordinate != 17)   alert("checkObj6Col12: error  42");
    if (c.label != "OR")  alert("checkObj6Col12: error  44");
    //if (c.parent.label != "Canada") alert("checkObj6Col12: error  45");
    c = inp[11];
    if (c.axisCoordinate != 18)   alert("checkObj6Col12: error  46");
    if (c.label != "WA")  alert("checkObj6Col12: error  47");
    //if (c.parent.label != "Canada") alert("checkObj6Col12: error  48");
};
...
//
//  obj7   3 top level nodes   for 3 Measures
//
HighChartUnitTests.prototype.checkObj7Col10 = function(inp) {
    if (inp.length != 3)  alert("checkObj7Col10: error  1");
    var c = inp[0];
    if (c.axisCoordinate != 0)   alert("checkObj7Col10: error  2");
    if (c.label != "Store Sales")  alert("checkObj7Col10: error  4");
    c = inp[1];
    if (c.axisCoordinate != 1)   alert("checkObj7Col10: error  3");
    if (c.label != "Store Cost")  alert("checkObj7Col10: error  5");
    c = inp[2];
    if (c.axisCoordinate != 2)   alert("checkObj7Col10: error  6");
    if (c.label != "Unit Sales")  alert("checkObj7Col10: error  7");
};


//
//  obj7   1 top level nodes
//
HighChartUnitTests.prototype.checkObj7Row00 = function(inp) {
    if (inp.length != 1)  alert("checkObj7Row00: error  1");
    var c = inp[0];
    if (c.axisCoordinate != 15)   alert("checkObj7Row0: error  2");
};

//
//  obj8   2 top level nodes   for 2 Measures
//
HighChartUnitTests.prototype.checkObj8Col10 = function(inp) {
    if (inp.length != 2)  alert("checkObj8Col10: error  1");
    var c = inp[0];
    if (c.axisCoordinate != 12)   alert("checkObj8Col10: error  2");
    if (c.label != "Store Sales")  alert("checkObj8Col10: error  4");
    c = inp[1];
    if (c.axisCoordinate != 13)   alert("checkObj8Col10: error  3");
    if (c.label != "Store Cost")  alert("checkObj8Col10: error  5");
};


//
//  obj8   2 countries    for 2 Measures
//
HighChartUnitTests.prototype.checkObj8Col11 = function(inp) {
    if (inp.length != 4)  alert("checkObj8Col11: error  1");
    var c = inp[0];
    if (c.axisCoordinate != 2)   alert("checkObj8Col11: error  2");
    if (c.label != "Store Sales")  alert("checkObj8Col11: error  4");
    if (c.parent.parent.label != "Canada") alert("checkObj8Col11: error  5");
    c = inp[1];
    if (c.axisCoordinate != 3)   alert("checkObj8Col11: error  6");
    if (c.label != "Store Cost")  alert("checkObj8Col11: error  7");
    if (c.parent.parent.label != "Canada") alert("checkObj8Col11: error  8");
    c = inp[2];
    if (c.axisCoordinate != 10)   alert("checkObj8Col11: error  12");
    if (c.label != "Store Sales")  alert("checkObj8Col11: error  14");
    if (c.parent.parent.label != "USA") alert("checkObj8Col11: error  15");
    c = inp[3];
    if (c.axisCoordinate != 11)   alert("checkObj8Col11: error  16");
    if (c.label != "Store Cost")  alert("checkObj8Col11: error  17");
    if (c.parent.parent.label != "USA") alert("checkObj8Col11: error  18");
};


//
//  obj8   2 countries  states  BC, CA, OR ,WA   for 2 Measures
//
HighChartUnitTests.prototype.checkObj8Col12 = function(inp) {
    if (inp.length != 8)  alert("checkObj8Col12: error  1");
    var c = inp[0];
    if (c.axisCoordinate != 0)   alert("checkObj8Col12: error  2");
    if (c.label != "Store Sales")  alert("checkObj8Col12: error  4");
    if (c.parent.parent.label != "Canada") alert("checkObj8Col12: error  5");
    c = inp[1];
    if (c.axisCoordinate != 1)   alert("checkObj8Col12: error  6");
    if (c.label != "Store Cost")  alert("checkObj8Col12: error  7");
    if (c.parent.parent.label != "Canada") alert("checkObj8Col12: error  8");
    c = inp[2];
    if (c.axisCoordinate != 4)   alert("checkObj8Col12: error  12");
    if (c.label != "Store Sales")  alert("checkObj8Col12: error  14");
    if (c.parent.parent.label != "USA") alert("checkObj8Col12: error  15");
    c = inp[3];
    if (c.axisCoordinate != 5)   alert("checkObj8Col12: error  16");
    if (c.label != "Store Cost")  alert("checkObj8Col12: error  17");
    if (c.parent.parent.label != "USA") alert("checkObj8Col12: error  18");

    c = inp[4];
    if (c.axisCoordinate != 6)   alert("checkObj8Col12: error  22");
    if (c.label != "Store Sales")  alert("checkObj8Col12: error  24");
    if (c.parent.parent.label != "USA") alert("checkObj8Col12: error  25");
    c = inp[5];
    if (c.axisCoordinate != 7)   alert("checkObj8Col12: error  26");
    if (c.label != "Store Cost")  alert("checkObj8Col12: error  27");
    if (c.parent.parent.label != "USA") alert("checkObj8Col12: error  28");

    var c = inp[6];
    if (c.axisCoordinate != 8)   alert("checkObj8Col12: error  32");
    if (c.label != "Store Sales")  alert("checkObj8Col12: error  34");
    if (c.parent.parent.label != "USA") alert("checkObj8Col12: error  35");
    c = inp[7];
    if (c.axisCoordinate != 9)   alert("checkObj8Col12: error  36");
    if (c.label != "Store Cost")  alert("checkObj8Col12: error  37");
    if (c.parent.parent.label != "USA") alert("checkObj8Col12: error  38");
};
...
//  Grand Total
//
HighChartUnitTests.prototype.checkObj20Col0 = function(inp) {
    if (inp.length != 1)  alert("checkObj20Col100: error  1");
    var c = inp[0];
    if (c.axisCoordinate != 0)   alert("checkObj20Col10: error  2");
...
//
//   All Product Totals for 3 countries
//
//
HighChartUnitTests.prototype.checkObj20Col10 = function(inp) {
    if (inp.length != 3)  alert("checkObj20Col10: error  1");
    var c = inp[0];
    if (c.axisCoordinate != 9)   alert("checkObj20Col10: error  2");
    if (c.label != "ALL")  alert("checkObj20Col10: error  4");

    c = inp[1];
    if (c.axisCoordinate != 18)   alert("checkObj20Col10: error  6");
    if (c.label != "ALL")  alert("checkObj20Col10: error  7");

    c = inp[2];
    if (c.axisCoordinate != 27)   alert("checkObj20Col10: error  12");
...
//
//  Product Family subtotals for all countries
//
//
HighChartUnitTests.prototype.checkObj20Col01 = function(inp) {
    if (inp.length != 3)  alert("checkObj20Col10: error  1");
    var c = inp[0];
    if (c.axisCoordinate != 1)   alert("checkObj20Col10: error  2");
    if (c.label != "ALL")  alert("checkObj20Col10: error  4");

    c = inp[1];
    if (c.axisCoordinate != 4)   alert("checkObj20Col10: error  6");
    if (c.label != "ALL")  alert("checkObj20Col10: error  7");

    c = inp[2];
    if (c.axisCoordinate != 6)   alert("checkObj20Col10: error  12");
    if (c.label != "ALL")  alert("checkObj20Col10: error  14");
};


// testcase  obj20  OLAP  Col 1 1

// test leaf level Product Family subtotals  for each Country
//
//        var dimLevels = [];
//        dimLevels.push({ level: 1 });
//        dimLevels.push({ level: 1 });
//
//        var testObj20Col11 = this.DataProcessor.fn.getNodeListForDimLevelRadio(1, dimLevels);
//        unitTest.checkObj20Col11(testObj20Col11);
//
//
HighChartUnitTests.prototype.checkObj20Col11 = function(inp) {
    if (inp.length != 9)  alert("checkObj20Col11: error  1");
    var c = inp[0];
    if (c.axisCoordinate != 10)   alert("checkObj20Col11: error  2");
    if (c.label != "ALL")  alert("checkObj20Col11: error  3");

    c = inp[1];
    if (c.axisCoordinate != 13)   alert("checkObj20Col11: error  4");
    if (c.label != "ALL")  alert("checkObj20Col11: error  5");

    c = inp[2];
    if (c.axisCoordinate != 15)   alert("checkObj20Col11: error  6");
    if (c.label != "ALL")  alert("checkObj20Col11: error  7");
    var c = inp[3];
    if (c.axisCoordinate != 19)   alert("checkObj20Col11: error  12");
    if (c.label != "ALL")  alert("checkObj20Col11: error  13");

    c = inp[4];
    if (c.axisCoordinate != 22)   alert("checkObj20Col11: error  14");
    if (c.label != "ALL")  alert("checkObj20Col11: error  15");

    c = inp[5];
    if (c.axisCoordinate != 24)   alert("checkObj20Col11: error  16");
    if (c.label != "ALL")  alert("checkObj20Col11: error  17");
    var c = inp[6];
    if (c.axisCoordinate != 28)   alert("checkObj20Col11: error  22");
    if (c.label != "ALL")  alert("checkObj20Col11: error  23");

    c = inp[7];
    if (c.axisCoordinate != 31)   alert("checkObj20Col11: error  24");
    if (c.label != "ALL")  alert("checkObj20Col11: error  25");

    c = inp[8];
    if (c.axisCoordinate != 33)   alert("checkObj20Col11: error  26");
    if (c.label != "ALL")  alert("checkObj20Col11: error  27");
};
...
//
//        var testObj20Col02 = this.DataProcessor.fn.getNodeListForDimLevelRadio(1, dimLevels);
//        unitTest.checkObj20Col02(testObj20Col02);
//
//
HighChartUnitTests.prototype.checkObj20Col02 = function(inp) {
    if (inp.length != 5)  alert("checkObj20Col02: error  1");
    var c = inp[0];
    if (c.axisCoordinate != 2)   alert("checkObj20Col02: error  2");
    if (c.label != "Alcoholic Beverages")  alert("checkObj20Col02: error  3");

    c = inp[1];
    if (c.axisCoordinate != 3)   alert("checkObj20Col02: error  4");
    if (c.label != "Beverages")  alert("checkObj20Col02: error  5");

    c = inp[2];
    if (c.axisCoordinate != 5)   alert("checkObj20Col02: error  6");
    if (c.label != "Baked Goods")  alert("checkObj20Col02: error  7");
    var c = inp[3];
    if (c.axisCoordinate != 7)   alert("checkObj20Col02: error  12");
    if (c.label != "Carousel")  alert("checkObj20Col02: error  13");

    c = inp[4];
    if (c.axisCoordinate != 8)   alert("checkObj20Col02: error  14");
    if (c.label != "Checkout")  alert("checkObj20Col02: error  15");
...
//        dimLevels.push({ level: 2 });
//
//        var testObj20Col12 = this.DataProcessor.fn.getNodeListForDimLevelRadio(1, dimLevels);


HighChartUnitTests.prototype.checkObj20Col12 = function(inp) {
    if (inp.length != 15)  alert("checkObj20Col12: error  1");
    var c = inp[0];
    if (c.axisCoordinate != 11)   alert("checkObj20Col12: error  2");
    if (c.label != "Alcoholic Beverages")  alert("checkObj20Col12: error  3");

    c = inp[1];
    if (c.axisCoordinate != 12)   alert("checkObj20Col12: error  4");
    if (c.label != "Beverages")  alert("checkObj20Col12: error  5");

    c = inp[2];
    if (c.axisCoordinate != 14)   alert("checkObj20Col12: error  6");
    if (c.label != "Baked Goods")  alert("checkObj20Col12: error  7");

    var c = inp[3];
    if (c.axisCoordinate != 16)   alert("checkObj20Col12: error  12");
    if (c.label != "Carousel")  alert("checkObj20Col12: error  13");

    c = inp[4];
    if (c.axisCoordinate != 17)   alert("checkObj20Col12: error  14");
    if (c.label != "Checkout")  alert("checkObj20Col12: error  15");

    c = inp[5];
    if (c.axisCoordinate != 20)   alert("checkObj20Col12: error  16");
    if (c.label != "Alcoholic Beverages")  alert("checkObj20Col12: error  17");

    var c = inp[6];
    if (c.axisCoordinate != 21)   alert("checkObj20Col12: error  22");
    if (c.label != "Beverages")  alert("checkObj20Col12: error  23");

    c = inp[7];
    if (c.axisCoordinate != 23)   alert("checkObj20Col12: error  24");
    if (c.label != "Baked Goods")  alert("checkObj20Col12: error  25");

    c = inp[8];
    if (c.axisCoordinate != 25)   alert("checkObj20Col12: error  26");
    if (c.label != "Carousel")  alert("checkObj20Col12: error  27");

    var c = inp[9];
    if (c.axisCoordinate != 26)   alert("checkObj20Col12: error  32");
    if (c.label != "Checkout")  alert("checkObj20Col12: error  33");

    c = inp[10];
    if (c.axisCoordinate != 29)   alert("checkObj20Col12: error  34");
    if (c.label != "Alcoholic Beverages")  alert("checkObj20Col12: error  35");

    c = inp[11];
    if (c.axisCoordinate != 30)   alert("checkObj20Col12: error  36");
    if (c.label != "Beverages")  alert("checkObj20Col12: error  37");

    var c = inp[12];
    if (c.axisCoordinate != 32)   alert("checkObj20Col12: error  42");
    if (c.label != "Baked Goods")  alert("checkObj20Col12: error 43");

    c = inp[13];
    if (c.axisCoordinate != 34)   alert("checkObj20Col12: error  44");
    if (c.label != "Carousel")  alert("checkObj20Col12: error  45");

    c = inp[14];
    if (c.axisCoordinate != 35)   alert("checkObj20Col12: error  46");
    if (c.label != "Checkout")  alert("checkObj20Col12: error  47");
...
//
// testcase  Obj22    label generation for Column Leaf mTx321m
//                       verify that we skip over the Product Family label "Food"
//                       and show ONLY "Baked Good" for the Product Dimensionb
//
//                             USA - Food - Baked Goods - Store Sales
//
HighChartUnitTests.prototype.checkObj22LabelGen00 = function() {
    var unitTest = this;
    var it = AdhocDataProcessor;

    var colTreeNodes = it.treeNodeAxes[1];

    var theNode = unitTest.findChildWithLabel(colTreeNodes, "USA");
    theNode = unitTest.findChildWithLabel(theNode, "Food");
    theNode = unitTest.findChildWithLabel(theNode, "Baked Goods");
    theNode = unitTest.findChildWithLabel(theNode, "Store Sales");
    var labelArray = it.fn.getLabelNameArray(1, theNode);

    if (labelArray.length != 3)    alert("checkObj22LabelGen00:  error 0");
    if (labelArray[0] !== 'Store Sales')   alert("checkObj22LabelGen00:  error 1");
    if (labelArray[1] !== 'Baked Goods')   alert("checkObj22LabelGen00:  error 2");
    if (labelArray[2] !== 'USA')   alert("checkObj22LabelGen00:  error 3");
...
//
// testcase  Obj22    label generation for Column Leaf mTx321m
//                      verify that we do not show the ALL label
//
//                             USA - Food  - Store Sales
//
HighChartUnitTests.prototype.checkObj22LabelGen01 = function() {
    var unitTest = this;
    var it = AdhocDataProcessor;
    ...
    var theNode = unitTest.findChildWithLabel(colTreeNodes, "USA");
    theNode = unitTest.findChildWithLabel(theNode, "Food");
    theNode = unitTest.findChildWithLabel(theNode, "ALL");
    theNode = unitTest.findChildWithLabel(theNode, "Store Sales");
    var labelArray = it.fn.getLabelNameArray(1, theNode);

    if (labelArray.length != 3)    alert("checkObj22LabelGen01:  error 0");
    if (labelArray[0] !== 'Store Sales')   alert("checkObj22LabelGen01:  error 1");
    if (labelArray[1] !== 'Food')   alert("checkObj22LabelGen01:  error 2");
    if (labelArray[2] !== 'USA')   alert("checkObj22LabelGen01:  error 3");
...
// testcase  Obj22    label generation for Column Leaf mTx321m
//                      verify that we do not show the ALL label
//                       where ALL is the leaf node
//
//                             USA - Food
//
HighChartUnitTests.prototype.checkObj22LabelGen02 = function() {
    var unitTest = this;
    var it = AdhocDataProcessor;
    ...
    if (labelArray.length != 2)    alert("checkObj22LabelGen01:  error 0");
    if (labelArray[0] !== 'Food')   alert("checkObj22LabelGen01:  error 2");
    if (labelArray[1] !== 'USA')   alert("checkObj22LabelGen01:  error 3");
...
//
// testcase  Obj22  OLAP  Col 0 0
//
//  Grand Total
//
HighChartUnitTests.prototype.checkObj22Col0 = function(inp) {
    if (inp.length != 1)  alert("checkObj22Col100: error  1");
    var c = inp[0];
    if (c.axisCoordinate != 0)   alert("checkObj22Col10: error  2");

};


// testcase  Obj22  OLAP  Col 1 0
//
//   All Product Totals for 3 countries
//
//
HighChartUnitTests.prototype.checkObj22Col10 = function(inp) {
    if (inp.length != 3)  alert("checkObj22Col10: error  1");
    var c = inp[0];
    if (c.axisCoordinate != 9)   alert("checkObj22Col10: error  2");
    if (c.label != "Store Sales")  alert("checkObj22Col10: error  4");

    c = inp[1];
    if (c.axisCoordinate != 18)   alert("checkObj22Col10: error  6");
    if (c.label != "Store Sales")  alert("checkObj22Col10: error  7");

    c = inp[2];
    if (c.axisCoordinate != 27)   alert("checkObj22Col10: error  12");
    if (c.label != "Store Sales")  alert("checkObj22Col10: error  14");
...
//
// testcase  Obj22  OLAP  Col 0 1
//
//  Product Family subtotals for all countries
//
//
HighChartUnitTests.prototype.checkObj22Col01 = function(inp) {
    if (inp.length != 3)  alert("checkObj22Col10: error  1");
    var c = inp[0];
    if (c.axisCoordinate != 1)   alert("checkObj22Col10: error  2");
    if (c.label != "Store Sales")  alert("checkObj22Col10: error  4");

    c = inp[1];
    if (c.axisCoordinate != 4)   alert("checkObj22Col10: error  6");
    if (c.label != "Store Sales")  alert("checkObj22Col10: error  7");

    c = inp[2];
    if (c.axisCoordinate != 6)   alert("checkObj22Col10: error  12");
    if (c.label != "Store Sales")  alert("checkObj22Col10: error  14");
};


// testcase  Obj22  OLAP  Col 1 1
...
//        dimLevels.push({ level: 1 });
//
//        var testObj22Col11 = this.DataProcessor.fn.getNodeListForDimLevelRadio(1, dimLevels);
//        unitTest.checkObj22Col11(testObj22Col11);
//
//
HighChartUnitTests.prototype.checkObj22Col11 = function(inp) {
    if (inp.length != 9)  alert("checkObj22Col11: error  1");
    var c = inp[0];
    if (c.axisCoordinate != 10)   alert("checkObj22Col11: error  2");
    if (c.label != "Store Sales")  alert("checkObj22Col11: error  3");

    c = inp[1];
    if (c.axisCoordinate != 13)   alert("checkObj22Col11: error  4");
    if (c.label != "Store Sales")  alert("checkObj22Col11: error  5");

    c = inp[2];
    if (c.axisCoordinate != 15)   alert("checkObj22Col11: error  6");
    if (c.label != "Store Sales")  alert("checkObj22Col11: error  7");
    var c = inp[3];
    if (c.axisCoordinate != 19)   alert("checkObj22Col11: error  12");
    if (c.label != "Store Sales")  alert("checkObj22Col11: error  13");

    c = inp[4];
    if (c.axisCoordinate != 22)   alert("checkObj22Col11: error  14");
    if (c.label != "Store Sales")  alert("checkObj22Col11: error  15");

    c = inp[5];
    if (c.axisCoordinate != 24)   alert("checkObj22Col11: error  16");
    if (c.label != "Store Sales")  alert("checkObj22Col11: error  17");
    var c = inp[6];
    if (c.axisCoordinate != 28)   alert("checkObj22Col11: error  22");
    if (c.label != "Store Sales")  alert("checkObj22Col11: error  23");

    c = inp[7];
    if (c.axisCoordinate != 31)   alert("checkObj22Col11: error  24");
    if (c.label != "Store Sales")  alert("checkObj22Col11: error  25");

    c = inp[8];
    if (c.axisCoordinate != 33)   alert("checkObj22Col11: error  26");
    if (c.label != "Store Sales")  alert("checkObj22Col11: error  27");
};



// testcase  Obj22  OLAP  Col 0 2
...
//        dimLevels.push({ level: 2 });
//
//        var testObj22Col02 = this.DataProcessor.fn.getNodeListForDimLevelRadio(1, dimLevels);
//        unitTest.checkObj22Col02(testObj22Col02);
//
//
HighChartUnitTests.prototype.checkObj22Col02 = function(inp) {
    if (inp.length != 5)  alert("checkObj22Col02: error  1");
    var c = inp[0];
    if (c.axisCoordinate != 2)   alert("checkObj22Col02: error  2");
    if (c.label != "Store Sales")  alert("checkObj22Col02: error  3");

    c = inp[1];
    if (c.axisCoordinate != 3)   alert("checkObj22Col02: error  4");
    if (c.label != "Store Sales")  alert("checkObj22Col02: error  5");

    c = inp[2];
    if (c.axisCoordinate != 5)   alert("checkObj22Col02: error  6");
    if (c.label != "Store Sales")  alert("checkObj22Col02: error  7");
    var c = inp[3];
    if (c.axisCoordinate != 7)   alert("checkObj22Col02: error  12");
    if (c.label != "Store Sales")  alert("checkObj22Col02: error  13");

    c = inp[4];
    if (c.axisCoordinate != 8)   alert("checkObj22Col02: error  14");
    if (c.label != "Store Sales")  alert("checkObj22Col02: error  15");
...
//        dimLevels.push({ level: 2 });
//
//        var testObj22Col12 = this.DataProcessor.fn.getNodeListForDimLevelRadio(1, dimLevels);


HighChartUnitTests.prototype.checkObj22Col12 = function(inp) {
    if (inp.length != 15)  alert("checkObj22Col12: error  1");
    var c = inp[0];
    if (c.axisCoordinate != 11)   alert("checkObj22Col12: error  2");
    if (c.label != "Store Sales")  alert("checkObj22Col12: error  3");

    c = inp[1];
    if (c.axisCoordinate != 12)   alert("checkObj22Col12: error  4");
    if (c.label != "Store Sales")  alert("checkObj22Col12: error  5");

    c = inp[2];
    if (c.axisCoordinate != 14)   alert("checkObj22Col12: error  6");
    if (c.label != "Store Sales")  alert("checkObj22Col12: error  7");

    var c = inp[3];
    if (c.axisCoordinate != 16)   alert("checkObj22Col12: error  12");
    if (c.label != "Store Sales")  alert("checkObj22Col12: error  13");

    c = inp[4];
    if (c.axisCoordinate != 17)   alert("checkObj22Col12: error  14");
    if (c.label != "Store Sales")  alert("checkObj22Col12: error  15");

    c = inp[5];
    if (c.axisCoordinate != 20)   alert("checkObj22Col12: error  16");
    if (c.label != "Store Sales")  alert("checkObj22Col12: error  17");

    var c = inp[6];
    if (c.axisCoordinate != 21)   alert("checkObj22Col12: error  22");
    if (c.label != "Store Sales")  alert("checkObj22Col12: error  23");

    c = inp[7];
    if (c.axisCoordinate != 23)   alert("checkObj22Col12: error  24");
    if (c.label != "Store Sales")  alert("checkObj22Col12: error  25");

    c = inp[8];
    if (c.axisCoordinate != 25)   alert("checkObj22Col12: error  26");
    if (c.label != "Store Sales")  alert("checkObj22Col12: error  27");

    var c = inp[9];
    if (c.axisCoordinate != 26)   alert("checkObj22Col12: error  32");
    if (c.label != "Store Sales")  alert("checkObj22Col12: error  33");

    c = inp[10];
    if (c.axisCoordinate != 29)   alert("checkObj22Col12: error  34");
    if (c.label != "Store Sales")  alert("checkObj22Col12: error  35");

    c = inp[11];
    if (c.axisCoordinate != 30)   alert("checkObj22Col12: error  36");
    if (c.label != "Store Sales")  alert("checkObj22Col12: error  37");

    var c = inp[12];
    if (c.axisCoordinate != 32)   alert("checkObj22Col12: error  42");
    if (c.label != "Store Sales")  alert("checkObj22Col12: error 43");

    c = inp[13];
    if (c.axisCoordinate != 34)   alert("checkObj22Col12: error  44");
    if (c.label != "Store Sales")  alert("checkObj22Col12: error  45");

    c = inp[14];
    if (c.axisCoordinate != 35)   alert("checkObj22Col12: error  46");
    if (c.label != "Store Sales")  alert("checkObj22Col12: error  47");
...
//        dimLevels.push({ level: 0 });
//
//        var testObj23Col10 = this.DataProcessor.fn.getNodeListForDimLevelRadio(1, dimLevels);

HighChartUnitTests.prototype.checkObj23Col10 = function(inp) {
    if (inp.length != 6)  alert("checkObj23Col10: error  1");
    var c = inp[0];
    if (c.axisCoordinate != 0)   alert("checkObj23Col10: error  2");
    if (c.label != "All Products")  alert("checkObj23Col10: error  3");

    c = inp[1];
    if (c.axisCoordinate != 1)   alert("checkObj23Col10: error  4");
    if (c.label != "All Products")  alert("checkObj23Col10: error  5");

    c = inp[2];
    if (c.axisCoordinate != 5)   alert("checkObj23Col10: error  6");
    if (c.label != "All Products")  alert("checkObj23Col10: error  7");

    var c = inp[3];
    if (c.axisCoordinate != 9)   alert("checkObj23Col10: error  12");
    if (c.label != "All Products")  alert("checkObj23Col10: error  13");

    c = inp[4];
    if (c.axisCoordinate != 13)   alert("checkObj23Col10: error  14");
    if (c.label != "All Products")  alert("checkObj23Col10: error  15");

    c = inp[5];
    if (c.axisCoordinate != 17)   alert("checkObj23Col10: error  16");
    if (c.label != "All Products")  alert("checkObj23Col10: error  17");
};
...
HighChartUnitTests.prototype.checkObj23Col11 = function(inp) {
    if (inp.length != 15)  alert("checkObj23Col11: error  1");
    var c = inp[0];
    if (c.axisCoordinate != 2)   alert("checkObj23Col11: error  2");
    if (c.label != "Drink")  alert("checkObj23Col11: error  3");

    c = inp[1];
    if (c.axisCoordinate != 3)   alert("checkObj23Col11: error  4");
    if (c.label != "Food")  alert("checkObj23Col11: error  5");

    c = inp[2];
    if (c.axisCoordinate != 4)   alert("checkObj23Col11: error  6");
    if (c.label != "Non-Consumable")  alert("checkObj23Col11: error  7");

    var c = inp[3];
    if (c.axisCoordinate != 6)   alert("checkObj23Col11: error  12");
    if (c.label != "Drink")  alert("checkObj23Col11: error  13");

    c = inp[4];
    if (c.axisCoordinate != 7)   alert("checkObj23Col11: error  14");
    if (c.label != "Food")  alert("checkObj23Col11: error  15");

    c = inp[5];
    if (c.axisCoordinate != 8)   alert("checkObj23Col11: error  16");
    if (c.label != "Non-Consumable")  alert("checkObj23Col11: error  17");

    var c = inp[6];
    if (c.axisCoordinate != 10)   alert("checkObj23Col11: error  22");
    if (c.label != "Drink")  alert("checkObj23Col11: error  23");

    c = inp[7];
    if (c.axisCoordinate != 11)   alert("checkObj23Col11: error  24");
    if (c.label != "Food")  alert("checkObj23Col11: error  25");

    c = inp[8];
    if (c.axisCoordinate != 12)   alert("checkObj23Col11: error  26");
    if (c.label != "Non-Consumable")  alert("checkObj23Col11: error  27");

    var c = inp[9];
    if (c.axisCoordinate != 14)   alert("checkObj23Col11: error  32");
    if (c.label != "Drink")  alert("checkObj23Col11: error  33");

    c = inp[10];
    if (c.axisCoordinate != 15)   alert("checkObj23Col11: error  34");
    if (c.label != "Food")  alert("checkObj23Col11: error  35");

    c = inp[11];
    if (c.axisCoordinate != 16)   alert("checkObj23Col11: error  36");
    if (c.label != "Non-Consumable")  alert("checkObj23Col11: error  37");

    var c = inp[12];
    if (c.axisCoordinate != 18)   alert("checkObj23Col11: error  42");
    if (c.label != "Drink")  alert("checkObj23Col11: error 43");

    c = inp[13];
    if (c.axisCoordinate != 19)   alert("checkObj23Col11: error  44");
    if (c.label != "Food")  alert("checkObj23Col11: error  45");

    c = inp[14];
    if (c.axisCoordinate != 20)   alert("checkObj23Col11: error  46");
    if (c.label != "Non-Consumable")  alert("checkObj23Col11: error  47");

};

HighChartUnitTests.prototype.checkObj24OLAPDimensionInfo = function(inp) {
     if (inp.length != 2)    alert("checkObj24OLAPDimensionInfo: error  1");
     var c0 = inp[0];
     if (c0.length != 0)   alert("checkObj24OLAPDimensionInfo: error  2");
     c0 = inp[1];
     if (c0.length != 2)   alert("checkObj24OLAPDimensionInfo: error  3");


     var c = c0[0];
     if (c.dimension !== "Customer")   alert("checkObj24OLAPDimensionInfo: error  4");
     var c1 = c.levels;
     if (c1.length != 3)    alert("checkObj24OLAPDimensionInfo: error  5");
     var c2 = c1[0];
     if (c2.levelName  !== "(All)")   alert("checkObj24OLAPDimensionInfo: error  6");
     if (c2.levelNumber !== 0)    alert("checkObj24OLAPDimensionInfo: error  7");
     var c2 = c1[1];
     if (c2.levelName  !== "Customer Country")   alert("checkObj24OLAPDimensionInfo: error  8");
     if (c2.levelNumber !== 1)    alert("checkObj24OLAPDimensionInfo: error  9");
     var c2 = c1[2];
     if (c2.levelName  !== "Customer State")   alert("checkObj24OLAPDimensionInfo: error  10");
     if (c2.levelNumber !== 2)    alert("checkObj24OLAPDimensionInfo: error  11");



     var c = c0[1];
     if (c.dimension !== "Products")   alert("checkObj24OLAPDimensionInfo: error  12");
     var c1 = c.levels;
     if (c1.length != 1)    alert("checkObj24OLAPDimensionInfo: error  13");
     var c2 = c1[0];
     if (c2.levelName  !== "Product Family")   alert("checkObj24OLAPDimensionInfo: error  14");
     if (c2.levelNumber !== 1)    alert("checkObj24OLAPDimensionInfo: error  15");
...
//
//    Product Family subtotals for ALL Customers   over 2 measures
//
HighChartUnitTests.prototype.checkObj24Col01 = function(inp) {
    if (inp.length != 4)  alert("checkObj24Col01: error  1");
    var c = inp[0];
    if (c.axisCoordinate != 0)   alert("checkObj24Col01: error  2");
    if (c.label != "Drink")  alert("checkObj24Col01: error  3");

    c = inp[1];
    if (c.axisCoordinate != 1)   alert("checkObj24Col01: error  4");
    if (c.label != "Food")  alert("checkObj24Col01: error  5");

    var c = inp[2];
    if (c.axisCoordinate != 12)   alert("checkObj24Col01: error  12");
    if (c.label != "Drink")  alert("checkObj24Col01: error  13");

    c = inp[3];
    if (c.axisCoordinate != 13)   alert("checkObj24Col01: error  14");
    if (c.label != "Food")  alert("checkObj24Col01: error  15");

};


//
//    Product Family subtotals for ALL Countries   over 2 measures
//
HighChartUnitTests.prototype.checkObj24Col11 = function(inp) {
    if (inp.length != 8)  alert("checkObj24Col11: error  1");
    var c = inp[0];
    if (c.axisCoordinate != 2)   alert("checkObj24Col11: error  2");
    if (c.label != "Drink")  alert("checkObj24Col11: error  3");

    c = inp[1];
    if (c.axisCoordinate != 3)   alert("checkObj24Col11: error  4");
    if (c.label != "Food")  alert("checkObj24Col11: error  5");

    var c = inp[2];
    if (c.axisCoordinate != 6)   alert("checkObj24Col11: error  12");
    if (c.label != "Drink")  alert("checkObj24Col11: error  13");

    c = inp[3];
    if (c.axisCoordinate != 7)   alert("checkObj24Col11: error  14");
    if (c.label != "Food")  alert("checkObj24Col11: error  15");

    var c = inp[4];
    if (c.axisCoordinate != 14)   alert("checkObj24Col11: error  22");
    if (c.label != "Drink")  alert("checkObj24Col11: error  23");

    c = inp[5];
    if (c.axisCoordinate != 15)   alert("checkObj24Col11: error  34");
    if (c.label != "Food")  alert("checkObj24Col11: error  35");

    var c = inp[6];
    if (c.axisCoordinate != 18)   alert("checkObj24Col11: error  42");
    if (c.label != "Drink")  alert("checkObj24Col11: error  43");

    c = inp[7];
    if (c.axisCoordinate != 19)   alert("checkObj24Col11: error  44");
    if (c.label != "Food")  alert("checkObj24Col11: error  45");
...
HighChartUnitTests.prototype.obj24 = function () {
  ...
  var md = new Object();
    ...
    // Store Cost  USA  ALL
    mTx30m.children = new Array(2);
    var mTx44 = new this.TestTreeNode();
    mTx44.label = "Drink";
    mTx44.level = 4;
    mTx44.axisCoordinate = 6;
    mTx44.isAll = false;
    mTx30m.children[0] = mTx44;
 ...
 **   cut and paste code to put unit test into highcharts.js to run:
       ...
       // Measures {Store Sales, Store Cost, Unit Sales}
         ...
         //unitTest.loadTest(json);
         //AdhocDataProcessor.fn.load(json);
         var sstate = new Object();
         sstate.queryData = testObj4;
         AdhocDataProcessor.fn.load(sstate);

         var testObj4Col10 = AdhocDataProcessor.fn.getNodeListForSliderLevel(1, 0);
         unitTest.checkObj4Col10(testObj4Col10);
         var leafArrayObj4Col10   = AdhocDataProcessor.fn.getLeafArrayFromNodeList(testObj4Col10);


         var testObj4Col11 = AdhocDataProcessor.fn.getNodeListForSliderLevel(1, 1);
         unitTest.checkObj4Col11(testObj4Col11);
         var leafArrayObj4Col11   = AdhocDataProcessor.fn.getLeafArrayFromNodeList(testObj4Col11);

         var testObj4Col12 = AdhocDataProcessor.fn.getNodeListForSliderLevel(1, 2);
         unitTest.checkObj4Col12(testObj4Col12);
         var leafArrayObj4Col12   = AdhocDataProcessor.fn.getLeafArrayFromNodeList(testObj4Col12);


         // since  level 3 is the last non-measure level, this is the same as (1, 4)
         // so we can use the (1, 4)
         var testObj4Col13 = AdhocDataProcessor.fn.getNodeListForSliderLevel(1, 3);
         unitTest.checkObj4Col14(testObj4Col13);
         var leafArrayObj4Col13   = AdhocDataProcessor.fn.getLeafArrayFromNodeList(testObj4Col13);

         var testObj4Col14 = AdhocDataProcessor.fn.getNodeListForSliderLevel(1, 4);
         unitTest.checkObj4Col14(testObj4Col14);
         var leafArrayObj4Col14   = AdhocDataProcessor.fn.getLeafArrayFromNodeList(testObj4Col14);
...
HighChartUnitTests.prototype.run = function () {
        ...
        var unitTest = this;
        this.loadTest = function(json) {
            var it = unitTest.DataProcessor;
            it.obj = jQuery.parseJSON(json);

            it.data = it.obj.data;
            it.metadata = it.obj.metadata;
            it.treeNodeAxes = it.obj.treeNodes;
    ...
    //  OLAP  measures first in Axis, Country Dimension 2 levels with ALL, product no ALL   level member
        ...
        var dimMappings = this.DataProcessor.fn.getOLAPDimensionInfo();
        unitTest.checkObj24OLAPDimensionInfo(dimMappings);
        ...
        var testObj24Col01 = this.DataProcessor.fn.getNodeListForDimLevelRadio(1, dimLevels);
        unitTest.checkObj24Col01(testObj24Col01);
        ...
        var testObj24Col11 = this.DataProcessor.fn.getNodeListForDimLevelRadio(1, dimLevels);
        unitTest.checkObj24Col11(testObj24Col11);
    ...
    //
        ...
        //var testObj23Col00 = this.DataProcessor.fn.getNodeListForDimLevelRadio(1, dimLevels);
        //unitTest.checkObj23Col00(testObj23Col00);
        //var leafArrayObj23Col00 = this.DataProcessor.fn.getLeafArrayFromNodeList(testObj23Col00);
        ...
        var testObj23Col11 = this.DataProcessor.fn.getNodeListForDimLevelRadio(1, dimLevels);
        ...
        var testObj20Col0 = this.DataProcessor.fn.getNodeListForDimLevelRadio(1, dimLevels);
        unitTest.checkObj20Col0(testObj20Col0);
        ...
        var testObj20Col10 = this.DataProcessor.fn.getNodeListForDimLevelRadio(1, dimLevels);
        ...
        var testObj20Col01 = this.DataProcessor.fn.getNodeListForDimLevelRadio(1, dimLevels);
        ...
        // most basic  OLAP crosstab:
        //
        //  this is Obj22  with  measures added for Dimension
        //
        //    COLUMN  DImension Customers
        //                  Level  All
        //                  Level  Customer Country
        ...
        //
        //
        //   the unit tests for Obj22  work for obj22 as is  b/c all we added was single measure at end
        ...
        var testObj22Col00 = this.DataProcessor.fn.getNodeListForDimLevelRadio(1, dimLevels);
        unitTest.checkObj22Col0(testObj22Col00);
        ...
        var testObj22Col10 = this.DataProcessor.fn.getNodeListForDimLevelRadio(1, dimLevels);
        unitTest.checkObj22Col10(testObj22Col10);
        ...
        var testObj22Col01 = this.DataProcessor.fn.getNodeListForDimLevelRadio(1, dimLevels);
        unitTest.checkObj22Col01(testObj22Col01);
       ...
       // test Product Family subtotals  under ALL Countries
        ...
        var testObj22Col02 = this.DataProcessor.fn.getNodeListForDimLevelRadio(1, dimLevels);
        //alert("unitTest.checkObj22Col02(testObj22Col02);  turned off");
        unitTest.checkObj22Col02(testObj22Col02);
        ...
        var testObj22Col12 = this.DataProcessor.fn.getNodeListForDimLevelRadio(1, dimLevels);
        //alert("unitTest.checkObj22Col12(testObj22Col12);  turned off");
  ...
  */
        ...
        var testNodeListRowSlider0 = this.DataProcessor.fn.getNodeListForSliderLevel(0, 0);
        unitTest.checkObj2Row0(testNodeListRowSlider0);
        //var leafArrayRowSlider0 = this.DataProcessor.fn.getLeafArrayFromNodeList(testNodeListRowSlider0);


        var testNodeListColSlider0 = this.DataProcessor.fn.getNodeListForSliderLevel(1, 0);
        unitTest.checkObj2Col0(testNodeListColSlider0);
        //var leafArrayColSlider0 = this.DataProcessor.fn.getLeafArrayFromNodeList(testNodeListColSlider0);


        var testNodeListRowSlider1 = this.DataProcessor.fn.getNodeListForSliderLevel(0, 1);
        unitTest.checkObj2Row1(testNodeListRowSlider1);
        //var leafArrayNodeListRowSlider1   = this.DataProcessor.fn.getLeafArrayFromNodeList(testNodeListRowSlider1);


        var testNodeListColSlider11 = this.DataProcessor.fn.getNodeListForSliderLevel(1, 1);
        unitTest.checkObj2Col1(testNodeListColSlider11);
        //var leafArrayNodeListColSlider11   = this.DataProcessor.fn.getLeafArrayFromNodeList(testNodeListColSlider11);


        var testNodeListColSlider12 = this.DataProcessor.fn.getNodeListForSliderLevel(1, 2);
        unitTest.checkObj2Col2(testNodeListColSlider12);
        //var leafArrayNodeListColSlider12   = this.DataProcessor.fn.getLeafArrayFromNodeList(testNodeListColSlider12);



        // ROW:  Product Family.
        // COLUMN:   Customer Country (USA, Canada), {Store Sales, Unit Sales}, State (BC, CA, OR, WA)
        ...
        var test2middleMeasuresColSlider10 = this.DataProcessor.fn.getNodeListForSliderLevel(1, 0);
        unitTest.checkObj3Col10(test2middleMeasuresColSlider10);

        var test2middleMeasuresColSlider11 = this.DataProcessor.fn.getNodeListForSliderLevel(1, 1);
        unitTest.checkObj3Col11(test2middleMeasuresColSlider11);

        var test2middleMeasuresColSlider12 = this.DataProcessor.fn.getNodeListForSliderLevel(1, 2);
        unitTest.checkObj3Col12(test2middleMeasuresColSlider12);
        ...
        var testObj5Col10 = this.DataProcessor.fn.getNodeListForSliderLevel(1, 0);
        unitTest.checkObj5Col10(testObj5Col10);


        var testObj5Col11 = this.DataProcessor.fn.getNodeListForSliderLevel(1, 1);
        unitTest.checkObj5Col11(testObj5Col11);
        ...
        var testObj4Col10 = this.DataProcessor.fn.getNodeListForSliderLevel(1, 0);
        unitTest.checkObj4Col10(testObj4Col10);



        var testObj4Col11 = this.DataProcessor.fn.getNodeListForSliderLevel(1, 1);
        unitTest.checkObj4Col11(testObj4Col11);


        var testObj4Col12 = this.DataProcessor.fn.getNodeListForSliderLevel(1, 2);
        unitTest.checkObj4Col12(testObj4Col12);


        // since  level 3 is the last non-measure level, this is the same as (1, 4)
        // so we can use the (1, 4)
        var testObj4Col13 = this.DataProcessor.fn.getNodeListForSliderLevel(1, 3);
        unitTest.checkObj4Col13(testObj4Col13);


        var testObj4Col14 = this.DataProcessor.fn.getNodeListForSliderLevel(1, 4);
        //unitTest.checkObj4Col14(testObj4Col14);



        //var datamapper = highchartDataMapper;
        ...
        //  ROW    Product Family
        //  COLUMNS   3  Measures, Customer Country, Customer State     measures first
        //  Measures:  Store Sales, Store Cost, Unit Sales
        ...
        var testObj6Col10 = this.DataProcessor.fn.getNodeListForSliderLevel(1, 0);
        unitTest.checkObj6Col10(testObj6Col10);


        var testObj6Col11 = this.DataProcessor.fn.getNodeListForSliderLevel(1, 1);
        unitTest.checkObj6Col11(testObj6Col11);

        var testObj6Col12 = this.DataProcessor.fn.getNodeListForSliderLevel(1, 2);
        unitTest.checkObj6Col12(testObj6Col12);
        ...
        var testObj7Col10 = this.DataProcessor.fn.getNodeListForSliderLevel(1, 0);
        unitTest.checkObj7Col10(testObj7Col10);


        var testObj7Row00 = this.DataProcessor.fn.getNodeListForSliderLevel(0, 0);
        unitTest.checkObj7Row00(testObj7Row00);


        //datamapper = highchartDataMapper;
        ...
        //  NO we should be getting back 2  store sales == 12   sotre cost == 13
        var testObj8Col10 = this.DataProcessor.fn.getNodeListForSliderLevel(1, 0);
        unitTest.checkObj8Col10(testObj8Col10);


        var testObj8Col11 = this.DataProcessor.fn.getNodeListForSliderLevel(1, 1);
        unitTest.checkObj8Col11(testObj8Col11);

        var testObj8Col12 = this.DataProcessor.fn.getNodeListForSliderLevel(1, 2);
        unitTest.checkObj8Col12(testObj8Col12);



        var testObj8Row00 = this.DataProcessor.fn.getNodeListForSliderLevel(0, 0);
        //var leafArrayObj8Row00 = this.DataProcessor.fn.getLeafArrayFromNodeList(testObj8Row00);
...
HighChartUnitTests.prototype.run = function () {
        ...
        var testNodeListRowSlider0 = this.DataProcessor.fn.getNodeListForSliderLevel(0, 0);
        unitTest.checkObj2NodeListRow00(testNodeListRowSlider0);
        var leafArrayRowSlider0 = this.DataProcessor.fn.getLeafArrayFromNodeList(testNodeListRowSlider0);


        var testNodeListColSlider0 = this.DataProcessor.fn.getNodeListForSliderLevel(1, 0);
        unitTest.checkObj2NodeListCol00(testNodeListColSlider0);
        var leafArrayColSlider0 = this.DataProcessor.fn.getLeafArrayFromNodeList(testNodeListColSlider0);


        var testNodeListRowSlider1 = this.DataProcessor.fn.getNodeListForSliderLevel(0, 1);
        unitTest.checkObj2NodeListRow01(testNodeListRowSlider1);
        var leafArrayNodeListRowSlider1   = this.DataProcessor.fn.getLeafArrayFromNodeList(testNodeListRowSlider1);


        var testNodeListColSlider11 = this.DataProcessor.fn.getNodeListForSliderLevel(1, 1);
        unitTest.checkObj2NodeListCol11(testNodeListColSlider11);
        var leafArrayNodeListColSlider11   = this.DataProcessor.fn.getLeafArrayFromNodeList(testNodeListColSlider11);


        var testNodeListColSlider12 = this.DataProcessor.fn.getNodeListForSliderLevel(1, 2);
        unitTest.checkObj2NodeListCol12(testNodeListColSlider12);
        var leafArrayNodeListColSlider12   = this.DataProcessor.fn.getLeafArrayFromNodeList(testNodeListColSlider12);
        ...
        var leafArray2middleMeasuresColSlider10   = this.DataProcessor.fn.getLeafArrayFromNodeList(test2middleMeasuresColSlider10);

        var test2middleMeasuresColSlider11 = this.DataProcessor.fn.getNodeListForSliderLevel(1, 1);
        unitTest.check2middleMeasuresColSlider11(test2middleMeasuresColSlider11);
        var leafArray2middleMeasuresColSlider11   = this.DataProcessor.fn.getLeafArrayFromNodeList(test2middleMeasuresColSlider11);

        var test2middleMeasuresColSlider12 = this.DataProcessor.fn.getNodeListForSliderLevel(1, 2);
        unitTest.check2middleMeasuresColSlider12(test2middleMeasuresColSlider12);
        var leafArray2middleMeasuresColSlider12   = this.DataProcessor.fn.getLeafArrayFromNodeList(test2middleMeasuresColSlider12);
        ...
        var leafArrayObj5Col10   = this.DataProcessor.fn.getLeafArrayFromNodeList(testObj5Col10);

        var testObj5Col11 = this.DataProcessor.fn.getNodeListForSliderLevel(1, 1);
        unitTest.checkObjCol11(testObj5Col11);
        var leafArrayObj5Col11   = this.DataProcessor.fn.getLeafArrayFromNodeList(testObj5Col11);
        ...
        var testObj4Col10 = this.DataProcessor.fn.getNodeListForSliderLevel(1, 0);
        unitTest.checkObj4Col10(testObj4Col10);
        var leafArrayObj4Col10   = this.DataProcessor.fn.getLeafArrayFromNodeList(testObj4Col10);


        var testObj4Col11 = this.DataProcessor.fn.getNodeListForSliderLevel(1, 1);
        unitTest.checkObj4Col11(testObj4Col11);
        var leafArrayObj4Col11   = this.DataProcessor.fn.getLeafArrayFromNodeList(testObj4Col11);

        var testObj4Col12 = this.DataProcessor.fn.getNodeListForSliderLevel(1, 2);
        unitTest.checkObj4Col12(testObj4Col12);
        var leafArrayObj4Col12   = this.DataProcessor.fn.getLeafArrayFromNodeList(testObj4Col12);

        // since  level 3 is the last non-measure level, this is the same as (1, 4)
        // so we can use the (1, 4)
        var testObj4Col13 = this.DataProcessor.fn.getNodeListForSliderLevel(1, 3);
        unitTest.checkObj4Col14(testObj4Col13);
        var leafArrayObj4Col13   = this.DataProcessor.fn.getLeafArrayFromNodeList(testObj4Col13);

        var testObj4Col14 = this.DataProcessor.fn.getNodeListForSliderLevel(1, 4);
        unitTest.checkObj4Col14(testObj4Col14);
        var leafArrayObj4Col14   = this.DataProcessor.fn.getLeafArrayFromNodeList(testObj4Col14);
        ...
        var testObj6Col10 = this.DataProcessor.fn.getNodeListForSliderLevel(1, 0);
        var leafArrayObj6Col10 = this.DataProcessor.fn.getLeafArrayFromNodeList(testObj6Col10);


        var testObj6Col11 = this.DataProcessor.fn.getNodeListForSliderLevel(1, 1);
        var leafArrayObj6Col11 = this.DataProcessor.fn.getLeafArrayFromNodeList(testObj6Col11);

        var testObj6Col12 = this.DataProcessor.fn.getNodeListForSliderLevel(1, 2);
        var leafArrayObj6Col12 = this.DataProcessor.fn.getLeafArrayFromNodeList(testObj6Col12);
        ...
        var testObj7Col10 = this.DataProcessor.fn.getNodeListForSliderLevel(1, 0);
        var leafArrayObj7Col10 = this.DataProcessor.fn.getLeafArrayFromNodeList(testObj7Col10);

        var testObj7Row00 = this.DataProcessor.fn.getNodeListForSliderLevel(0, 0);
        var leafArrayObj7Row00 = this.DataProcessor.fn.getLeafArrayFromNodeList(testObj7Row00);
        ...
        var testObj8Col10 = this.DataProcessor.fn.getNodeListForSliderLevel(1, 0);
        var leafArrayObj8Col10 = this.DataProcessor.fn.getLeafArrayFromNodeList(testObj8Col10);

        var testObj8Col11 = this.DataProcessor.fn.getNodeListForSliderLevel(1, 1);
        var leafArrayObj8Col11 = this.DataProcessor.fn.getLeafArrayFromNodeList(testObj8Col11);

        var testObj8Col12 = this.DataProcessor.fn.getNodeListForSliderLevel(1, 2);
        var leafArrayObj8Col12 = this.DataProcessor.fn.getLeafArrayFromNodeList(testObj8Col12);
