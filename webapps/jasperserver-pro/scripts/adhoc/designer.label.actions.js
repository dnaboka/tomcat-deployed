            ...
            if (dialog) {
                ...
                if (type === "legend") {
                    ...
                    if(selectedColumn){
                        ...
                        var headerText = headerSpan ? headerSpan.innerHTML.trim() : getInnerText(selectedColumn.header);
    ...
    adhocDesigner.returnToNormalReportTitle = function(evt) {
        if(editor){
            ...
            if(evt.keyCode == Event.KEY_ESC){
                ...
                editor.makeNonEditable();
                var title = xssUtil.unescape(editor.elem.innerHTML);
