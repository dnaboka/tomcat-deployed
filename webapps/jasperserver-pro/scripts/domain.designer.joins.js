...
dd.joins = {
    ...
    getValidationPostData: function() {
        return {
            ...
            joinsInput: Object.toJSON(this.joinsList.getItems()),
            page: this.PAGE
        }
    },

    validationCallback: function (json) {
        if (this.shouldUpdateTreeModel) {
            this.initTrees();
        }
    },

    getSelectedModel: function() {
        var rootNode = this.leftTree.getRootNode();
    ...
    fillForm: function() {
        ...
        $('joinsInput').writeAttribute('value', Object.toJSON(this.joinsList.getItems()));
    ...
    init: function(options) {
        ...
        dd_joins.checkDesignValidator.init(this.validationCallback.bind(this));
    ...
    afterLeftTreeLoaded: function() {
        ...
        this.shouldUpdateTreeModel = false;
    },
    ...
    removeJoin: function(joinListItem) {
        ...
        this.shouldUpdateTreeModel = true;
    },
    ...
    changeNodeAlias: function(node, newValue) {
       ...
       if (!dd.emptyValidator(newValue).isValid || !dd.itemIdValidator(null, newValue).isValid || this.isNewAliasExists(newValue)) {
