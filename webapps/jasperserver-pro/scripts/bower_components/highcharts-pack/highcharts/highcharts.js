...
//
// #12 08/28/2017 JSSEC-7: Escaped output to el.innerHTML against XSS attack.
//
// #13 01/23/2018 JS-28588: [case #58307] visualize.js fails with error when rendering Highcharts chart if global Highcharts is already on page
//
///////////////////////////////////////////////////////////////////////
    ...
    extend(SVGRenderer.prototype, {
        ...
        html: function (str, x, y) {
            ...
            wrapper.textSetter = function (value) {
                ...
                //START JASPERSOFT #12
                element.innerHTML = this.textStr = Highcharts.escapeXSS(value);
                //END JASPERSOFT #12
    ...
    */
    ...
    extend(Chart.prototype, {
        ...
        showLoading: function (str) {
            ...
            // update text
            //START JASPERSOFT #12
            chart.loadingSpan.innerHTML = Highcharts.escapeXSS(str || options.lang.loading);
            //END JASPERSOFT #12
