...
define(function (require) {
    ...
    var BaseComponentModel = require("./BaseComponentModel"),
        ...
        log = require("logger").register("TableColumnComponent");
    ...
    return BaseComponentModel.extend({
        ...
        initialize: function(config){
            ...
            if (this.get("canFormatHeading")) {
                this.headingFormat = new FormatModel(this.get("headingsTabContent"), { parse: true, silent: true });
            }
        ...
        attachEvents: function() {
            ...
            this.on("parentTableComponentAttached", function() {
                if (this.config.conditionalFormattingData) {
                    ...
                    this.conditions.reset(this.config.conditionalFormattingData.conditions, { silent: true, parse: true });
                }
            });
        },
        ...
        parse: function(response) {
            ...
            if (response.filtering && response.filtering.filterData) {
                var dataType = jiveDataConverter.dataTypeToSchemaFormat[response.dataType],
                    ...
                    filterPattern = response.filtering.filterData.filterPattern;
        ...
        updateFromReportComponentObject: function(obj) {
            ...
            if (obj.sort) {
                if (this.get("canSort")) {
                    ...
                    log.warn("The column cannot be sorted!");
                }
            }
            ...
            if (obj.filter) {
                if (this.get("canFilter")) {
                    ...
                    log.warn("The column cannot be filtered!");
                }
            }
            ...
            if (obj.label) {
                if (this.get("canFormatHeading")) {
                    ...
                    log.warn("The column label cannot be modified!");
                }
            }
            ...
            if (obj.headingFormat) {
                if (this.get("canFormatHeading")) {
                    ...
                    log.warn("The column heading cannot be modified!");
                }
            ...
            if (obj.conditions) {
                if (this.get("canFormatConditionally")) {
                    ...
                    log.warn("The column cannot be formatted conditionally!");
                }
            }
