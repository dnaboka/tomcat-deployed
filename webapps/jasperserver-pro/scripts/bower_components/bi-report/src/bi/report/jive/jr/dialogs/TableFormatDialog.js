...
define(function (require) {
    ...
    var _ = require("underscore"),
        ...
        tableFormatDialogTemplate = require("text!./template/tableFormatDialogTemplate.htm"),
        tabOptionTemplate = require("text!./template/tabOptionTemplate.htm"),
        TableBasicFormatView = require("./view/TableBasicFormatView"),
        TableConditionCollectionView = require("./view/TableConditionCollectionView");

    function applyFormat(evt) {
        if (!this.conditionFormatView.validate()) { return; }
