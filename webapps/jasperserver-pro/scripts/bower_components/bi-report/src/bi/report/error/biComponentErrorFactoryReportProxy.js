...
define(function (require, exports, module) {
    ...
    var biComponentErrorFactory = require("common/bi/error/biComponentErrorFactory"),
        ReportStatusError = require("./ReportStatusError"),
        ReportRenderError = require("./ReportRenderError");
    ...
    return biComponentErrorFactory;
});