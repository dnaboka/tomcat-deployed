...
// All rights reserved.
// License Agreement: http://www.tibco.com/assets/blt59b361e6644c8d3a/tibco-end-user-license-agreement_tcm8-9378.pdf
//
//@file: GeoAnalytics.js
//@version: v1.1.0
...
define(function(require) {
    ...
    var T = T || {};
    T.settings = {
        geoWebServices: (window.location.protocol != "https:" ? "http://geowebservices.maporama.com/" : "https://geowebservices.maporama.com/")
    };
    ...
    (function (exports) {
        ...
        EventDispatcher.prototype = {
            ...
            on: function (eventName, fn, context) {
                ...
                var f = context ? this.bind(fn, context) : fn,
                    events = this.events[eventName] = this.events[eventName] || {},
                    eventsContext = this.eventsContext[eventName] = this.eventsContext[eventName] || {};
    ...
    (function (exports) {
        ...
        var Bounds = function (a, b) {
            ...
            if (!a) { a = new T.Point(0, 0); }
            if (!b) { b = new T.Point(0, 0); }
    ...
    (function (exports) {
        ...
        var DomUtil = {
            ...
            getNodeIndex: function (node, parent) {
                ...
                var nodes =  parent ? parent.childNodes : node.parentNode.childNodes,
                    i;
    ...
    (function (exports) {
        ...
        var DomEventUtil = {
            ...
            on: function (obj, type, fn, context) {
                ...
                if (obj.addEventListener !== undefined) {
                    ...
                    if (type === 'mousewheel') {
                        ...
                        handler = function (e) {
                            if (!DomEventUtil.checkMouse(obj, e)) { return; }
            ...
            off: function (obj, type, fn) {  // (HTMLElement, String, Function)
        ...
        DragUtil.prototype = {
            ...
            onMove: function (evt) {
                ...
                var newPoint = new T.Point(evt.clientX, evt.clientY),
                    offset = newPoint.substract(this.startPoint);
                ...
                // Apply positions
                T.DomUtil.position(this.element, this.newPos);
    ...
    (function (exports) {
        ...
        var AnimUtil = {
            ...
            transition: function (element, time, pos, type) {
                ...
                element.style.transition = 'transform ' + time + 's cubic-bezier(.17,.67,1,.84)';
    ...
    (function () {
        ...
        return (function e(t, n, r) {
            ...
            },{}],"Jf/0WF":[function(_dereq_,module,exports){
                var projs = [
    ...
    (function (exports) {
        ...
        var Crs = function (options) {
            ...
            this.maxProjected = this.projection.project(new T.LatLng(0, 179.9999));
        ...
        Crs.prototype =	{
            ...
            latLngToPoint: function (latlng, zoom) {
                var projectedPoint = this.project(latlng),
                    point =  this.transform(projectedPoint, zoom);
            ...
            pointToLatLng: function (point, zoom) {
                var untransformedPoint = this.untransform(point, zoom),
                    latlng =  this.unproject(untransformedPoint);
            ...
            transform: function (point, zoom) {
                var scale = this.scale(zoom),
                    transformedPoint = this.transformation.transform(point, scale);
    ...
    (function (exports) {
        ...
        MarkerDragHandler.prototype = {
            ...
            init: function (marker) {
                ...
                //this.marker.$container.style.cursor = 'move';
            },
    ...
    (function (exports) {
        ...
        MouseWheelHandler.prototype = {
            ...
            onMouseWheel: function (evt) {
                var util = T.DomEventUtil,
                    delta = util.getWheelDelta(evt),
                    mousePosition = this.map.computeMousePosition(evt),
                    centerInPixels = this.calculateCenterInPixels(mousePosition),
                    center = this.map.unproject(centerInPixels),
                    zoom,
                    self;
    ...
    (function(exports) {
        ...
        Map.prototype = {
            ...
            options: {
                ...
                maxZoom: 18,
                maxExtent: null,
                center: new T.LatLng(46.0, 2.0),
                crs: new T.Crs({
                    code: "EPSG:3857"
                }),
                repeatX: true,
                repeatY: false, // obsolete,
                urlLocation: true,
                noHistory: true,
                geolocate: false,
                controls: {
                    attribution: {
                        prefix: "<a target='_blank' href='http://www.tibco.com/assets/blt59b361e6644c8d3a/tibco-end-user-license-agreement_tcm8-9378.pdf'>©TIBCO GeoAnalytics</a>"
                    }
                }
            },
            ...
            initContainer: function(container) {
                ...
                T.DomEventUtil.on(window, 'resize', this.reset, this);
            ...
            setPositionFromUrl: function() {
                var urlPosition = T.Util.getBrowserUrlHash(),
                    urlContent = null,
                    urlItems = [],
                    latitude = null,
                    longitude = null,
            ...
            zoomAround: function(latlng, zoom, withAnim) {
                ...
                if (T.AnimUtil.canAnim() && withAnim) {
                    ...
                    T.AnimUtil.transition(this.$layers, 0.100);
            ...
            limitBounds: function() {
                ...
                var currentBounds = this.getBounds(),
                    maxBounds = this.options.maxExtent,
                    newBounds = new T.LatLngBounds(currentBounds.getSouthWest(), currentBounds.getNorthEast()),
                    boundsChanged = false;

                if (!T.Util.floatEqual(currentBounds.northEast.lat, maxBounds.northEast.lat) &&
                    currentBounds.northEast.lat > maxBounds.northEast.lat) {
                ...
                } else if (!T.Util.floatEqual(currentBounds.southWest.lat, maxBounds.southWest.lat) &&
                    currentBounds.southWest.lat < maxBounds.southWest.lat) {
                ...
                if (!T.Util.floatEqual(currentBounds.northEast.lng, maxBounds.northEast.lng) &&
                    currentBounds.northEast.lng > maxBounds.northEast.lng) {
                ...
                } else if (!T.Util.floatEqual(currentBounds.southWest.lng, maxBounds.southWest.lng) &&
                    currentBounds.southWest.lng < maxBounds.southWest.lng) {
            ...
            getProjectedBounds: function() {
                ...
                var key,
                    ...
                    size = this.getSize(),
                    bottomLeft = new T.Point(0, 0),
                    topRight = new T.Point(0, 0),
                    projCenter = this.untransform(this.calculateCenterInPixel()),
                    half = size.divideBy(2).multiplyBy(crs.resolutions[this.getZoom()]); //map.untransform(size.divideBy(2));
        ...
        Path.prototype = {
            ...
            initContainer: function () {
                ...
                if (this.context) {
                    ...
                    //throw new Error("Geometry context not available.");
                }
    ...
    (function (exports) {
        ...
        Polyline.prototype = {
            ...
            projectCoords: function () {
                ...
                for (i = 0; i < this.coords.length; i++) {
                    this.projectedCoords.push(
                        this.layer.map.latLngToContainerPoint(
                            this.options.reverseCoordinates ? this.coords[i].concat().reverse() : this.coords[i]
                        ).floor()
                    );
                }
            }
        ...
        //Extend class
        T.Util.inherit(Polyline, T.Path);
            ...
            projectCoords: function () {
                ...
                for (i = 0; i < this.coords.length; i++) {
                    ...
                    for (j = 0; j < this.coords[i].length; j++) {
                        line.push(
                            this.layer.map.latLngToContainerPoint(
                                this.options.reverseCoordinates ? this.coords[i][j].concat().reverse() :  this.coords[i][j]
                            ).floor()
                        );
                    }
    ...
    (function (exports) {
        ...
        //Extend class
        T.Util.inherit(MultiPolyline, T.Path);
    ...
    (function (exports) {
                ...
                for (k = 0; k < this.coords.length; k++) {
                    ...
                    for (i = 0; i < this.coords[k].length; i++) {
                        ...
                        for (j = 0; j < this.coords[k][i].length; j++) {
                            line.push(
                                this.layer.map.latLngToContainerPoint(
                                    this.options.reverseCoordinates ? this.coords[k][i][j].concat().reverse() :  this.coords[k][i][j]
                                ).floor()
                            );
                        }
        ...
        //Extend class
        T.Util.inherit(MultiPolygon, T.Path);
    ...
    (function (exports) {
        ...
        //Extend class
        T.Util.inherit(Rectangle, T.Polygon);
        ...
        Circle.prototype = {
            ...
            projectCoords: function () {
                ...
                if (this.radiusMeasure === "meter") {
                    ...
                    this.porjectedStartPoint = this.layer.map.latLngToContainerPoint(this.options.reverseCoordinates ? [this.center.lng, this.center.lat - diff] : [this.center.lat, this.center.lng - diff]).floor();
                } else {
        ...
        SvgContext.prototype = {
            ...
            initContainer: function (geometry) {
                ...
                if (!geometry.$container) {
                    ...
                    geometry.$container.appendChild(geometry.$path);
            ...
            draw: function (geometry) {
                ...
                if (path) {
                    ...
                    geometry.$path.setAttributeNS(null, 'd', "M 0 0");

                    /* WebKit throws ' Error: Problem parsing d="" ' when having empty d attribute */
        ...
        TileLayer.prototype = {
            ...
            initContainer: function () {
                ...
                if (!this.$container) {
                    ...
                    this.$layerContainer = T.DomUtil.create(
                        'div',
                        'tibco-layer tile-layer',
                        this.map.$container.layers
                    );

                    this.$container = T.DomUtil.create(
                        'div',
                        'tibco-layer tile-layer-1',
                        this.$layerContainer
                    );

                    this.$bufferContainer = T.DomUtil.create(
                        'div',
                        'tibco-layer tile-layer-2',
                        this.$layerContainer
                    );
            ...
            handleBackBuffer: function () {
                ...
                var backPercent = this.getLoadedTilesPercent(this.$bufferContainer);
            ...
            getTileUrl: function (point) {
                ...
                if (x >= 0 && x < tileCount &&  y >= 0 && y < tileCount) {
                    return T.Util.template(this.url, {x: x, y: y, z: point.z});
                }
            ...
            getTilePosition: function (point) {
                ...
                var tileSize	= this.options.tileSize,
                    topLeft		= this.map.getCenterInPixels().substract(this.map.getSize().divideBy(2)).floor();
            ...
            onAdd: function (map) {
                ...
                this.map = map;
                this.map.events.on('hard-reset', function () { this.hardReset = true; }, this);
            ...
            onTileError: function (e) {
                ...
                if (this.errorAttempts < this.layer.options.errorTileAttemptsThreshold) {
                    ...
                    this.layer.events.fire('tile-error', {tile: this});
            ...
            onAllTilesLoaded: function () {
                ...
                self.$bufferContainer.innerHTML = "";
            ...
            stopLoadingTiles: function (container) {
                var tiles = T.DomUtil.nodeCollectionToArray(container.getElementsByTagName('img')), // Array.prototype.slice.call(container.getElementsByTagName('img')),
                    i,
                    len,
                    tile;
    ...
    (function (exports) {
        ...
        // Extend class
        T.Util.inherit(MarkersLayer, base);
    ...
    (function (exports) {
        ...
        SvgLayer.prototype = {
            ...
            initContainer: function () {
                ...
                if (!this.$container) {
                    ...
                    this.context = new T.SvgContext(this.$svg);
            ...
            updateViewPort: function () {
                ...
                this.$svg.setAttributeNS(null, 'viewBox', [-padding.x, -padding.y, size.x, size.y].join(' '));
                this.$svg.$g.setAttributeNS(null, 'transform', "matrix(" + [1, 0, 0, 1, 0, 0].join(' ') + ")");
        ...
        // Extend class
        T.Util.inherit(SvgLayer, T.BaseLayer);
    ...
    (function (exports) {
        ...
        CanvasLayer.prototype = {
            ...
            initContainer: function () {
                ...
                if (!this.$container) {
                    ...
                    this.context = new T.CanvasContext(this.$canvas);
            ...
            updateViewPort: function () {
                ...
                //Adjust padding
                this.canvasContext.setTransform(1, 0, 0, 1, padding.x, padding.y);
        ...
        // Extend class
        T.Util.inherit(CanvasLayer, T.BaseLayer);
        ...
        VmlLayer.prototype = {
            ...
            initContainer: function () {
                ...
                if (!this.$container) {
                    ...
                    this.context = new T.VmlContext(this.$vml);
    ...
    (function(exports) {
        ...
        TibcoLayer.prototype = {
            ...
            setMapType: function(mapType) {
                ...
                this.makeRequest(this.mapTypeService.href).then(function(data) {
                    ...
                    self.map.events.fire("layer-attribution-reset", self);

                    // Save map type - specific service data
                    self.mapTypeServiceData = data;
            ...
            setMapStyle: function(mapStyle) {
                var availableMapStyles = this.mapTypeServiceData["tile styles"],
                    styleFound = false,
                    i = 0;
                ...
                if (!availableMapStyles) {
                    ...
                    for (i = 0; i < availableMapStyles.length; i++) {
                        if (availableMapStyles[i].id === mapStyle) {
                            ...
                            // Save map style
                            this.options.mapStyle = availableMapStyles[i].id;
        ...
        // Extend class
        T.Util.inherit(TibcoLayer, T.TileLayer);
    ...
    (function (exports) {
        ...
        WmsLayer.prototype = {
            ...
            reset: function (noTransform) {
                ...
                var key,
                    ...
                    url = this.wmsUrl,
                    map = this.map,
                    bounds = map.getProjectedBounds(),
                    param = this.computeParameters(bounds),
                    size = param.size,
                    topLeftPixel = param.topLeftPixel,
                    bottomLeft = param.bounds.bottomLeft(),
                    topRight = param.bounds.topRight();
            ...
            onImageLoad: function () {
                ...
                self.backImage.style.visibility = "hidden";
        ...
        // Extend class
        T.Util.inherit(WmsLayer, T.ImageLayer);
    ...
    (function (exports) {
        ...
        WmsTileLayer.prototype = {
            ...
            getTileUrl: function (point) {
                ...
                var size,
                    ...
                    tileSize = this.options.tileSize,
                    queryParams = this.options.queryParams,
                    tileSizePoint = new T.Point(tileSize, tileSize),
                    topLeft,
                    topRight,
                    bottomLeft,
                    bottomRight,
        ...
        // Extend class
        T.Util.inherit(WmsTileLayer, T.TileLayer);
    ...
    (function (exports) {
        ...
        // Extend class
        T.Util.inherit(PopupsLayer, T.BaseLayer);
    ...
    (function (exports) {
        ...
        Popup.prototype =	{
            ...
            initContainer: function () {
                ...
                if (!this.$container) {
                    ...
                    if (this.options.closeButtonUrl) {
                        // Create element
                        this.$closeButton = T.DomUtil.create(
                            'img',
                            'tibco-popup-close',
                            this.$container
                        );
                        ...
                        // Add img src
                        this.$closeButton.src = this.options.closeButtonUrl;

                        // Save popup so that we can access it in event handlers
                        this.$closeButton.popup = this;
                    }

                    this.$htmlContent = T.DomUtil.create(
                        'div',
                        'tibco-popup-content',
                        this.$container
                    );

                    this.$tail = T.DomUtil.create(
                        'div',
                        'tibco-popup-tail',
                        this.$container
                    );
            ...
            getPanOffset: function () {
                var offsetX = 0,
                    offsetY = 0,
                    popupPanPosition = this.getPositionWithPan();
            ...
            getPositionWithPan: function () {
                ...
                return {top: this.$container.tibcoPosition.y + layersContainerPanOffset.top,  left: this.$container.tibcoPosition.x + layersContainerPanOffset.left};
            },
        ...
        ScaleControl.prototype = {
            ...
            initContainer: function () {
                ...
                if (!this.$container) {
                    ...
                    this.$container.style.fontStyle = this.options.fontStyle;

                    //this.$container.controls = this;
                }
            },
            ...
            reset: function () {
                ...
                var resolution =  this.map.getMapResolution();
        ...
        AttributionControl.prototype = {
            ...
            initContainer: function() {
                ...
                if (!this.$container) {
                    this.$container = T.DomUtil.create(
                        'div',
                        'tibco-control tibco-attribution',
                        this.map.$container.controls
                    );
            ...
            reset: function() {
                ...
                if (!attribution) {
                    ...
                    this.$container.innerHTML = attribution;
                }
            },
    ...
    (function (exports) {
        ...
        var RulerControl = function (options) {
            ...
            this.polyline.setStyle({ color: "#FF0000", stroke: true });
        ...
        RulerControl.prototype = {
            ...
            addCoordinateAt: function (coord, index) {
                ...
                this.coordinates.splice(index, 0, [coord.lat, coord.lng]);
                this.reset();
            },

            reset: function () {

                this.vectorLayer.updateViewPort();
                //this.polyline.reset();
    ...
    (function (exports) {
        ...
        LayersControl.prototype = {
            ...
            createLayer: function (layer) {
                ...
                layerContainer = T.DomUtil.create('div', this.LAYER_CONTAINER_CLASS, this.$layersContainer);
                ...
                radio.checked = (layer === this.selectedLayerData) ? 'checked' : '';
                ...
                checkbox.checked = (layer.isVisible() === true) ? 'checked' : '';
            ...
            onSelectLayer: function (evt) {
                ...
                this.selectedLayerData = this.map.getLayers()[this.selectedLayerIndex];
            ...
            onSetLayerVisibility: function (evt) {
                ...
                var layer = null,
                    ...
                    layerVisible = targetEelement.checked;
    ...
    (function (exports) {
        ...
        TibcoMapControl.prototype = {
             ...
             */
            reset: function () {
                var layers = this.getMapTibcoLayers(),
                    i = 0;
            ...
            createLayerOptions: function () {
                var i = 0,
                    mapTypesContainer = null,
                    mapStylesContainer = null,
                    mapTypesOptionContainer = null,
                    mapStylesOptionContainer = null,
                    availableMapTypes = null,
                    availableMapStyles = null,
                    mapTypeLabelContainer = null,
                    mapStyleLabelContainer = null,
                    groupContainer = null;
                ...
                // Remove all options
                this.clearContainer(this.$layerOptionsContainer, this.LAYER_OPTIONS_GROUP_CLASS);
                ...
                availableMapTypes = this.selectedLayerData.getAvailableMapTypes();

                // Create map type option group
                groupContainer = T.DomUtil.create('div', this.LAYER_OPTIONS_GROUP_CLASS, this.$layerOptionsContainer);

                // Create map type label
                mapTypeLabelContainer = T.DomUtil.create('span', this.LAYER_OPTIONS_SELECT_CLASS, groupContainer);
                mapTypeLabelContainer.innerHTML = "Map type:";
                ...
                for (i = 0; i < availableMapTypes.length; i++) {
                    ...
                    mapTypesOptionContainer.innerHTML = availableMapTypes[i];
                    mapTypesContainer.appendChild(mapTypesOptionContainer);
                ...
                mapStyleLabelContainer.innerHTML = "Map style:";
                ...
                for (i = 0; i < availableMapStyles.length; i++) {
                    ...
                    mapStylesOptionContainer.innerHTML = availableMapStyles[i];
                    mapStylesContainer.appendChild(mapStylesOptionContainer);
    ...
    (function (exports) {
        ...
        NavigationControl.prototype = {
            ...
            createPanControl: function () {
                ...
                this.$panUpContainer.title = (this.options.titles && this.options.titles.panUp) ? this.options.titles.panUp : "";

                // DOWN
                this.$panDownContainer = T.DomUtil.create('div', this.PAN_DOWN_CLASS, this.$panContainer);
                this.$panDownContainer.title = (this.options.titles && this.options.titles.panDown) ? this.options.titles.panDown : "";

                // LEFT
                this.$panLeftContainer = T.DomUtil.create('div', this.PAN_LEFT_CLASS, this.$panContainer);
                this.$panLeftContainer.title = (this.options.titles && this.options.titles.panLeft) ? this.options.titles.panLeft : "";

                // RIGHT
                this.$panRightContainer = T.DomUtil.create('div', this.PAN_RIGHT_CLASS, this.$panContainer);
                this.$panRightContainer.title = (this.options.titles && this.options.titles.panRight) ? this.options.titles.panRight : "";
            ...
            createZoomControl: function () {
                ...
                this.$zoomInContainer.title = (this.options.titles && this.options.titles.zoomIn) ? this.options.titles.zoomIn : "";

                // ZOOM OUT
                this.$zoomOutContainer = T.DomUtil.create('div', this.ZOOM_OUT_CLASS, this.$zoomContainer);
                this.$zoomOutContainer.title = (this.options.titles && this.options.titles.zoomOut) ? this.options.titles.zoomOut : "";
                ...
                this.$zoomThumbContainer = T.DomUtil.create('div', this.ZOOM_THUMB_CLASS, this.$zoomRailContainer);
    ...
    (function (exports) {
        ...
        var GeocoderResult = function (resultObject) {
            ...
            // Set bounding box
            if (resultObject.BoundingBox && resultObject.BoundingBox.NorthEast
                && resultObject.BoundingBox.NorthEast.Latitude && resultObject.BoundingBox.NorthEast.Longitude
                && resultObject.BoundingBox.SouthWest && resultObject.BoundingBox.SouthWest.Latitude
                && resultObject.BoundingBox.SouthWest.Longitude) {
    ...
    (function (exports) {
        ...
        Geocoder.prototype = {
            ...
            geocode: function (options) {
                ...
                // Add geocoder
                url += "?geocoder=maporama";

                // Add authorization key
                url += "&maporamakey=" + this.key;
            ...
            reverseGeocode: function (latLngObject) {
                ...
                // Add latitude
                url += "&latitude=" + latLngObject.lat;

                // Add longitude
                url += "&longitude=" + latLngObject.lng;
