                ...
                if (dataType === "string") {
                    ...
                    if (dataType === "datetime") {
                        if (isRange) {
                            ...
                            response.value = jiveDataConverter.jQueryUiTimestampToIsoTimestamp(valueStart, genericProperties);
                        }
                        ...
                        if (isRange) {
                            ...
                            response.value = jiveDataConverter.jQueryUiTimeToIsoTime(valueStart, genericProperties);
                        }
                    }
                }
            }
