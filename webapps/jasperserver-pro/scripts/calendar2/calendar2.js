 ...
 * @version: $Id: calendar2.js 7721 2015-07-14 11:03:14Z psavushc $
 */


// THIS COMPONENT IS DEPRECATED! DO NOT USE IT FOR NEW PROJECTS!!! NEW COMPONENT SHOULD BE DEVELOPED!!!
...
define(function(require) {
    ...
    var $ = require("jquery"),
        ...
        calendar2Template = require("text!./template/calendar2Template.htm"),
            ...
            var calendar = {
                ...
                attachListeners: function() {
                    calendar.tabButtons.each(function(index, tab){
                        $(tab).bind("click", function(){calendar.activateTab(index)});
                    });
                    ...
                    $(document).bind("mousedown", calendar.checkExternalClick);
                },

                removeListeners: function() {
                    calendar.tabButtons.each(function(index, tab){
                        $(tab).unbind("click", function(){calendar.activateTab(index)});
                    });
                    ...
                    $(document).unbind("mousedown", calendar.checkExternalClick);
                },
