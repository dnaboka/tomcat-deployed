...
domain.chooser.fields = {
    ...
    fillForm: function() {
        ...
        var selectedModel
                = rootNode.childs.first()
                ? Object.toJSON(rootNode.childs.findAll(function(node) {
...
dc_fields.moveButtonsUpdateStatusEventFactory = $H({
    ...
    'toRight': function(params) {
        return params.sourceTreeHasVisibleNodes
                && this.isSameDataIslandsOnBothTrees(params.sourceTreeDataIslands, params.destTreeDataIslands);
    }
});
